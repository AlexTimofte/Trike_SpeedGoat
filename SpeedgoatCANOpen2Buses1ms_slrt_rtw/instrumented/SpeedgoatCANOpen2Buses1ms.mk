...
MODEL           = SpeedgoatCANOpen2Buses1ms
MODULES         = rt_matrx.c rt_printf.c rt_logging.c SpeedgoatCANOpen2Buses1ms.c SpeedgoatCANOpen2Buses1ms_capi.c SpeedgoatCANOpen2Buses1ms_data.c SpeedgoatCANOpen2Buses1ms_xcp.c SpeedgoatCANOpen2Buses1ms_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c CANOpenSlave.c CANOpenSlaveAPT.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = SpeedgoatCANOpen2Buses1ms.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = E:\SPEEDG~1\Git\WITHBU~1\TRIKE_~1
...
MODELLIB                  = SpeedgoatCANOpen2Buses1mslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SpeedgoatCANOpen2Buses1ms_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\SpeedgoatCANOpen2Buses1ms_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
