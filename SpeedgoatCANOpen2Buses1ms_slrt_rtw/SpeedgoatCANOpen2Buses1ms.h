...
typedef struct {
  ...
  int64_T RightTiltMotor_CurrentReqmA_f;/* '<S32>/Gain' */
  ...
  real_T TmpRTBAtSum2Inport1;          /* '<S37>/Gain1' */
  real_T Sum2;                         /* '<S37>/Sum2' */
  real_T Saturation2;                  /* '<S37>/Saturation2' */
  real_T BrakesMotor_CurrentReq;       /* '<S37>/Amp2mAmp' */
  real_T BrakesMotor_CurrentReq_h;     /* '<S29>/Subsystem' */
  real_T CastToSingle3;                /* '<S34>/Cast To Single3' */
  real_T Speed_SI;                     /* '<S34>/Gain2' */
  real_T VehSpeed_SI;                  /* '<S34>/WheelRadius' */
  real_T CastToSingle2;                /* '<S34>/Cast To Single2' */
  real_T VehSpeed_SIms1;
  real_T TmpRTBAtSumInport2;           /* '<S37>/offset' */
  real_T Sum;                          /* '<S37>/Sum' */
  real_T br_percent2;                  /* '<S37>/GetInPercent' */
  real_T Gain2;                        /* '<S37>/Gain2' */
  real_T Saturation;                   /* '<S37>/Saturation' */
  ...
  real_T Clock;                        /* '<S46>/Clock' */
  real_T Sum_b;                        /* '<S46>/Sum' */
  real_T MathFunction;                 /* '<S46>/Math Function' */
  real_T LookUpTable1;                 /* '<S46>/Look-Up Table1' */
  real_T Output;                       /* '<S46>/Output' */
  real_T TiltingAngle_sinreqdeg;       /* '<S32>/Sine Wave1' */
  real_T TiltingAngledeg;              /* '<S32>/ServoTilting' */
  real_T TiltingAngledeg_j;            /* '<S32>/Manual Switch1' */
  real_T TiltingAngle_stepreqfdeg;     /* '<S32>/Zero-Order Hold1' */
  real_T TmpRTBAtSumInport2_mb;        /* '<S32>/Offset' */
  real_T Fb_Angledeg;                  /* '<S32>/Sum' */
  real_T Saturation_a;                 /* '<S32>/Saturation' */
  real_T TmpRTBAtZeroOrderHold3Inport1;/* '<S32>/Moving Average' */
  real_T Fb_Angle_Filtdeg;             /* '<S32>/Zero-Order Hold3' */
  real_T e_in;                         /* '<S45>/Sum1' */
  real_T Hyst;                         /* '<S45>/Constant3' */
  real_T Product1;                     /* '<S45>/Product1' */
  real_T Proportional;                 /* '<S45>/Proportional  Gain' */
  real_T IntegralGain;                 /* '<S45>/Integral Gain' */
  real_T Delay;                        /* '<S45>/Delay' */
  real_T ZeroOrderHold;                /* '<S45>/Zero-Order Hold' */
  real_T Sum2_h;                       /* '<S45>/Sum2' */
  real_T Integral;                     /* '<S45>/Discrete-Time Integrator' */
  real_T Saturation_c;                 /* '<S45>/Saturation' */
  real_T TmpRTBAtDerivativeInport2;    /* '<S45>/Constant' */
  real_T TmpRTBAtDerivativeInport3;    /* '<S45>/Constant1' */
  real_T DataTypeConversion1;          /* '<S45>/Data Type Conversion1' */
  real_T Saturation3;                  /* '<S45>/Saturation3' */
  real_T Sum4;                         /* '<S45>/Sum4' */
  real_T Product2;                     /* '<S45>/Product2' */
  real_T Saturation2_d;                /* '<S45>/Saturation2' */
  real_T c1;                           /* '<S45>/c1' */
  ...
  real_T AntiWindup;                   /* '<S45>/AntiWindup' */
  real_T Hyst_f;                       /* '<S45>/Constant3' */
  real_T Memory1_d;                    /* '<S43>/Memory1' */
  real_T DispLeftOffsetVolt;           /* '<S43>/Sum' */
  real_T DispLeftm;                    /* '<S43>/Volt2meter' */
  real_T DispLeftm_k;                  /* '<S43>/Volt2meter' */
  real_T DiscreteFilter;               /* '<S43>/Discrete Filter' */
  real_T Memory1_g;                    /* '<S44>/Memory1' */
  real_T TmpRTBAtSumInport2_mbd;       /* '<S44>/Offset for 0 deg' */
  real_T DispRightOffsetVolt;          /* '<S44>/Sum' */
  real_T DispRightm;                   /* '<S44>/Volt2meter' */
  real_T DispRightm_e;                 /* '<S44>/Volt2meter' */
  real_T DiscreteFilter_e;             /* '<S44>/Discrete Filter' */
  real_T VehSpeed_Kmh;                 /* '<S34>/m//s2Km//h' */
  real_T CastToSingle1_e;              /* '<S34>/Cast To Single1' */
  real_T Gain1_e;                      /* '<S34>/Gain1' */
  real_T TractionReq_a;                /* '<S34>/Abs' */
  ...
  real_T speed_out;                    /* '<S32>/Cond1' */
  real_T MovingAverage;                /* '<S32>/Moving Average' */
  real_T TiltingAngledeg_k;            /* '<S32>/Manual Switch4' */
  real_T Sum4_e;                       /* '<S29>/Sum4' */
  real_T SpeedReq;                     /* '<S30>/P Controller' */
  real_T MovingAverage_m;              /* '<S30>/Moving Average' */
  ...
  real32_T TmpRTBAtDunkA_Steering_Init_Spe;/* '<S79>/Constant' */
  real32_T TmpRTBAtDunkC_TiltLeft_Init_Cur;/* '<S80>/Constant' */
  real32_T TmpRTBAtDunkB_TiltRight_Init_Cu;/* '<S81>/Constant' */
  real32_T TmpRTBAtDunkD_Brake_Init_Curren;/* '<S75>/Constant' */
  real32_T Sum_bp;                     /* '<S77>/Sum' */
  real32_T Joystick_LongCmd_i;         /* '<S10>/RPDOs from Joystick' */
  real32_T Joystick_LatCmd;            /* '<S10>/RPDOs from Joystick' */
  real32_T Retract_current_m;          /* '<S37>/Retract' */
  real32_T Joystick_LongCmd1;
  real32_T TmpRTBAtSum1Inport1;        /* '<S37>/Delay' */
  real32_T TmpRTBAtSum1Inport2;        /* '<S37>/Data Type Conversion1' */
  real32_T Sum1;                       /* '<S37>/Sum1' */
  real32_T TmpRTBAtRetractInport1;     /* '<S37>/Sum1' */
  real32_T DataTypeConversion1_c;      /* '<S37>/Data Type Conversion1' */
  real32_T TmpRTBAtRetractInport2;     /* '<S37>/Data Type Conversion1' */
  real32_T Delay_o;                    /* '<S37>/Delay' */
  real32_T TmpRTBAtDelayInport1;       /* '<S37>/Data Type Conversion1' */
  ...
  real32_T n;                          /* '<S32>/n' */
  real32_T Constant;                   /* '<S75>/Constant' */
  real32_T Constant_j;                 /* '<S79>/Constant' */
  real32_T Constant_m;                 /* '<S80>/Constant' */
  real32_T Constant_e;                 /* '<S81>/Constant' */
  real32_T ClearError;                 /* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  real32_T DeviceMode;                 /* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  real32_T BrakeCtrl;                  /* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  real32_T PowerEnable;                /* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  real32_T InitStatus;                 /* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  real32_T ClearError_h;               /* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  real32_T DeviceMode_f;               /* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  real32_T BrakeCtrl_m;                /* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  real32_T PowerEnable_m;              /* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  real32_T InitStatus_k;               /* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  real32_T ClearError_n;               /* '<S79>/DunkA_Steering_Init_SpeedMode' */
  real32_T DeviceMode_o;               /* '<S79>/DunkA_Steering_Init_SpeedMode' */
  real32_T BrakeCtrl_b;                /* '<S79>/DunkA_Steering_Init_SpeedMode' */
  real32_T PowerEnable_a;              /* '<S79>/DunkA_Steering_Init_SpeedMode' */
  real32_T InitStatus_f;               /* '<S79>/DunkA_Steering_Init_SpeedMode' */
  real32_T Enable;                     /* '<S27>/EnableCtrl' */
  real32_T ClearError_k;               /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  real32_T DeviceMode_b;               /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  real32_T BrakeCtrl_n;                /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  real32_T PowerEnable_au;             /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  real32_T BrakesMotor_CurrentInit;    /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  real32_T InitStatus_a;               /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  real32_T ud;                         /* '<S45>/Derivative' */
  real32_T yf;                         /* '<S45>/Derivative' */
  real32_T Br_CurrentReq;              /* '<S37>/Retract' */
  int32_T DispLeftVolt;                /* '<S43>/LSB2Volt' */
  int32_T DispRightVolt;               /* '<S44>/LSB2Volt' */
  ...
  int32_T LeftTiltMotor_CurrentFbmA;
  int32_T Product2_i;                  /* '<S32>/Product2' */
  int32_T ZeroOrderHold2;              /* '<S32>/Zero-Order Hold2' */
  int32_T current_out;                 /* '<S32>/Cond' */
  uint16_T APT_BusVoltage;             /* '<S2>/RPDOs from APT' */
  uint16_T DataTypeConversion;         /* '<S37>/Data Type Conversion' */
  uint16_T Saturation1;                /* '<S37>/Saturation1' */
  ...
  int16_T CurrentInit;                 /* '<S75>/Cast To Single4' */
  ...
  uint8_T BrakeCtrl_k2;                /* '<S75>/Cast To Single2' */
  uint8_T BrakeCtrl_o;
  ...
  boolean_T En;
  boolean_T ZeroOrderHold_d;           /* '<S32>/Zero-Order Hold' */
  boolean_T TmpRTBAtProduct2Inport1;   /* '<S32>/Zero-Order Hold' */
} B_SpeedgoatCANOpen2Buses1ms_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  dsp_simulink_MovingAverage_Sp_T obj; /* '<S30>/Moving Average' */
  dsp_simulink_MovingAverage_a_T obj_l;/* '<S32>/Moving Average' */
  ...
  real_T DiscreteFilter_states[2];     /* '<S43>/Discrete Filter' */
  real_T DiscreteFilter_states_p[2];   /* '<S44>/Discrete Filter' */
  ...
  real_T Sum2_DWORK1;                  /* '<S37>/Sum2' */
  real_T TmpRTBAtSumInport2_Buffer0;   /* synthesized block */
  real_T Sum_DWORK1;                   /* '<S37>/Sum' */
  ...
  volatile real_T TmpRTBAtZeroOrderHold3Inport1_B[2];/* synthesized block */
  ...
  real_T DiscreteFilter_tmp;           /* '<S43>/Discrete Filter' */
  real_T Memory1_PreviousInput_e;      /* '<S44>/Memory1' */
  real_T TmpRTBAtSumInport2_Buffer0_osg;/* synthesized block */
  volatile real_T DispRightm_Buffer[2];/* synthesized block */
  real_T DiscreteFilter_tmp_d;         /* '<S44>/Discrete Filter' */
  ...
  int64_T RightTiltMotor_CurrentReqmA_Buf;/* synthesized block */
  ...
  struct {
    void *AQHandles;
    void *SlioLTF;
  } HiddenToAsyncQueue_Inserted_pxk;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
    void *SlioLTF;
  } HiddenToAsyncQueue_InsertedF_fs;   /* synthesized block */
  ...
  struct {
    void *AQHandles;
    void *SlioLTF;
  } HiddenToAsyncQueue_Inserte_ijlo;   /* synthesized block */
  ...
  real32_T Delay_DSTATE_f[2];          /* '<S37>/Delay' */
  ...
  real32_T aux2;                       /* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  real32_T aux;                        /* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  real32_T aux2_k;                     /* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  real32_T aux_a;                      /* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  real32_T aux2_p;                     /* '<S79>/DunkA_Steering_Init_SpeedMode' */
  real32_T aux_j;                      /* '<S79>/DunkA_Steering_Init_SpeedMode' */
  real32_T aux2_l;                     /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  real32_T aux_k;                      /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  real32_T yf_k1;                      /* '<S45>/Derivative' */
  int32_T systemEnable;                /* '<S16>/Sine Wave' */
  int32_T DunkC_ActualCurrent_Buffer0; /* synthesized block */
  int32_T sfEvent;                     /* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  int32_T sfEvent_c;                   /* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  int32_T sfEvent_a;                   /* '<S79>/DunkA_Steering_Init_SpeedMode' */
  int32_T sfEvent_n;                   /* '<S27>/EnableCtrl' */
  int32_T sfEvent_j;                   /* '<S75>/DunkD_Brake_Init_CurrentMode' */
  int32_T sfEvent_b;                   /* '<S45>/Comp_and_Timer' */
  int32_T sfEvent_nr;                  /* '<S32>/Cond1' */
  int32_T sfEvent_bd;                  /* '<S32>/Cond' */
  int32_T sfEvent_h;                   /* '<S37>/Retract' */
  ...
  volatile int8_T TmpRTBAtZeroOrderHold3Inport1_A;/* synthesized block */
  volatile int8_T TmpRTBAtZeroOrderHold3Inport1_s;/* synthesized block */
  ...
  uint8_T is_active_c1_SpeedgoatCANOpen2B;/* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  uint8_T is_c1_SpeedgoatCANOpen2Buses1ms;/* '<S81>/DunkB_TiltRight_Init_CurrentMode' */
  uint8_T is_active_c2_SpeedgoatCANOpen2B;/* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  uint8_T is_c2_SpeedgoatCANOpen2Buses1ms;/* '<S80>/DunkC_TiltLeft_Init_CurrentMode' */
  uint8_T is_active_c12_SpeedgoatCANOpen2;/* '<S79>/DunkA_Steering_Init_SpeedMode' */
  uint8_T is_c12_SpeedgoatCANOpen2Buses1m;/* '<S79>/DunkA_Steering_Init_SpeedMode' */
  uint8_T is_active_c4_SpeedgoatCANOpen2B;/* '<S27>/EnableCtrl' */
  uint8_T is_c4_SpeedgoatCANOpen2Buses1ms;/* '<S27>/EnableCtrl' */
  uint8_T is_active_c3_SpeedgoatCANOpen2B;/* '<S75>/DunkD_Brake_Init_CurrentMode' */
  uint8_T is_c3_SpeedgoatCANOpen2Buses1ms;/* '<S75>/DunkD_Brake_Init_CurrentMode' */
  uint8_T is_active_c26_SpeedgoatCANOpen2;/* '<S45>/Comp_and_Timer' */
  uint8_T is_c26_SpeedgoatCANOpen2Buses1m;/* '<S45>/Comp_and_Timer' */
  uint8_T temporalCounter_i1;          /* '<S45>/Comp_and_Timer' */
  uint8_T is_active_c28_SpeedgoatCANOpen2;/* '<S32>/Cond1' */
  uint8_T is_c28_SpeedgoatCANOpen2Buses1m;/* '<S32>/Cond1' */
  uint8_T is_active_c24_SpeedgoatCANOpen2;/* '<S32>/Cond' */
  uint8_T is_c24_SpeedgoatCANOpen2Buses1m;/* '<S32>/Cond' */
  uint8_T is_active_c5_SpeedgoatCANOpen2B;/* '<S37>/Retract' */
  uint8_T is_c5_SpeedgoatCANOpen2Buses1ms;/* '<S37>/Retract' */
  uint8_T temporalCounter_i1_n;        /* '<S37>/Retract' */
  ...
  boolean_T TmpRTBAtProduct2Inport1_Buffer0;/* synthesized block */
...
struct P_SpeedgoatCANOpen2Buses1ms_T_ {
  real_T PID_ctrl2_Kd;                 /* Mask Parameter: PID_ctrl2_Kd
                                        * Referenced by: '<S45>/Constant'
                                        */
  real_T PID_ctrl2_Ki;                 /* Mask Parameter: PID_ctrl2_Ki
                                        * Referenced by:
                                        *   '<S45>/AntiWindup'
                                        *   '<S45>/Integral Gain'
                                        */
  real_T PID_ctrl2_Kp;                 /* Mask Parameter: PID_ctrl2_Kp
                                        * Referenced by:
                                        *   '<S45>/AntiWindup'
                                        *   '<S45>/Proportional  Gain'
                                        */
  real_T PID_ctrl2_Req_lim;            /* Mask Parameter: PID_ctrl2_Req_lim
                                        * Referenced by: '<S45>/Saturation'
                                        */
  real_T PID_ctrl2_Ts;                 /* Mask Parameter: PID_ctrl2_Ts
  ...
  real_T LookUpTable1_bp01Data[8];     /* Expression: rep_seq_t - min(rep_seq_t)
                                        * Referenced by: '<S46>/Look-Up Table1'
                                        */
  real_T SineWave1_Amp;                /* Expression: 2
  ...
  real_T TmpRTBAtSumInport2_InitialCo_jx;/* Expression: 0
                                          * Referenced by: synthesized block
                                          */
  real_T Saturation_UpperSat_j;        /* Expression: 30
                                        * Referenced by: '<S32>/Saturation'
                                        */
  real_T Saturation_LowerSat_d;        /* Expression: -30
                                        * Referenced by: '<S32>/Saturation'
                                        */
  real_T TmpRTBAtZeroOrderHold3Inport1_I;/* Expression: 0
                                          * Referenced by: synthesized block
                                          */
  ...
  real_T TmpRTBAtDerivativeInport3_Initi;/* Expression: 0
                                          * Referenced by: synthesized block
                                          */
  real_T Saturation3_UpperSat;         /* Expression: 500
                                        * Referenced by: '<S45>/Saturation3'
                                        */
  real_T Saturation3_LowerSat;         /* Expression: -500
                                        * Referenced by: '<S45>/Saturation3'
                                        */
  real_T Saturation2_UpperSat_f;       /* Expression: 1500
                                        * Referenced by: '<S45>/Saturation2'
                                        */
  real_T Saturation2_LowerSat_j;       /* Expression: -1500
                                        * Referenced by: '<S45>/Saturation2'
                                        */
  ...
  real_T Offset_Value;                 /* Expression: 0
                                        ...
                                        */
  real_T Constant3_Value;              /* Expression: 0.4
  ...
  real_T TmpRTBAtSumInport2_InitialC_jxk;/* Expression: 0
                                          * Referenced by: synthesized block
                                          */
  real_T Volt2meter_Gain_a;            /* Expression: 0.076/5
                                        * Referenced by: '<S44>/Volt2meter'
                                        */
  real_T DispRightm_InitialCondition;  /* Expression: 0
                                        * Referenced by: synthesized block
                                        */
  real_T DiscreteFilter_NumCoef_l[3];  /* Expression: [0.0201 0.0402 0.0201]
                                        * Referenced by: '<S44>/Discrete Filter'
                                        */
  real_T DiscreteFilter_DenCoef_a[3];  /* Expression: [1 -1.561 0.6414]
                                        * Referenced by: '<S44>/Discrete Filter'
                                        */
  real_T DiscreteFilter_InitialStates_i;/* Expression: 0
                                         * Referenced by: '<S44>/Discrete Filter'
                                         */
  real_T Offsetfor0deg_Value_k;        /* Expression: 3.39224644
  ...
  int64_T RightTiltMotor_CurrentReqmA_Ini;/* Computed Parameter: RightTiltMotor_CurrentReqmA_Ini
                                           * Referenced by: synthesized block
                                           */
  int32_T DunkC_ActualCurrent_InitialCond;/* Computed Parameter: DunkC_ActualCurrent_InitialCond
                                           * Referenced by: synthesized block
                                           */
  ...
  int16_T LSB2Volt_Gain;               /* Computed Parameter: LSB2Volt_Gain
                                        ...
                                        */
  int16_T LSB2Volt_Gain_f;             /* Computed Parameter: LSB2Volt_Gain_f
 ...
 * '<S33>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum'
 * '<S34>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TractionControl'
 * '<S35>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/BrakeControl/DecisionBrakeCtrl'
 * '<S36>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/BrakeControl/MATLAB Function'
 * '<S37>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/BrakeControl/Subsystem'
 * '<S38>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/BrakeControl/Subsystem/Retract'
 * '<S39>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/SteeringControl/P Controller'
 * '<S40>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/SteeringControl/Repeating Sequence'
 * '<S41>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/Cond'
 * '<S42>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/Cond1'
 * '<S43>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/Offset_Conversion'
 * '<S44>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/Offset_Conversion2'
 * '<S45>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/PID_ctrl2'
 * '<S46>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/Repeating Sequence1'
 * '<S47>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/ServoTilting'
 * '<S48>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/PID_ctrl2/Comp_and_Timer'
 * '<S49>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl/PID_ctrl2/Derivative'
 * '<S50>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/Load Torque Luenberger Observer'
 * '<S51>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/Offset_Conversion'
 * '<S52>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/Offset_Conversion1'
 * '<S53>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_Angle'
 * '<S54>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispLeft'
 * '<S55>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispLeft1'
 * '<S56>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispRight'
 * '<S57>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/Repeating Sequence1'
 * '<S58>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/Repeating Sequence2'
 * '<S59>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/Repeating Sequence3'
 * '<S60>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/ServoTilting'
 * '<S61>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/Te'
 * '<S62>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/Tl'
 * '<S63>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_Angle/Comp_and_Timer'
 * '<S64>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_Angle/Derivative'
 * '<S65>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_Angle/Discrete Derivative'
 * '<S66>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispLeft/Comp_and_Timer'
 * '<S67>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispLeft/Derivative'
 * '<S68>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispLeft/Discrete Derivative'
 * '<S69>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispLeft1/Comp_and_Timer'
 * '<S70>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispLeft1/Derivative'
 * '<S71>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispRight/Comp_and_Timer'
 * '<S72>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispRight/Derivative'
 * '<S73>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Control/TiltingControl_withoutbum/PID_DispRight/Discrete Derivative'
 * '<S74>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/APTControlWord'
 * '<S75>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/Brakes_DunkMotor_Init'
 * '<S76>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/ButtonStatus'
 * '<S77>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/Enable'
 * '<S78>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/EnableCtrl'
 * '<S79>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/Steering_DunkMotor_Init'
 * '<S80>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init'
 * '<S81>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init'
 * '<S82>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/Brakes_DunkMotor_Init/DunkD_Brake_Init_CurrentMode'
 * '<S83>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/Enable/Compare To Constant'
 * '<S84>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/Steering_DunkMotor_Init/DunkA_Steering_Init_SpeedMode'
 * '<S85>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/DunkC_TiltLeft_Init_CurrentMode'
 * '<S86>'  : 'SpeedgoatCANOpen2Buses1ms/Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/DunkB_TiltRight_Init_CurrentMode'
 */
