/*
 * SpeedgoatCANOpen2Buses1ms_types.h
 *
...
#ifndef RTW_HEADER_SpeedgoatCANOpen2Buses1ms_types_h_
#define RTW_HEADER_SpeedgoatCANOpen2Buses1ms_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_dsp_private_SlidingWindowAv_a_T
#define typedef_dsp_private_SlidingWindowAv_a_T
...
typedef struct {
  ...
  real_T pCumSumRev[9];
  real_T pCumRevIndex;
} dsp_private_SlidingWindowAv_a_T;

#endif                                 /*typedef_dsp_private_SlidingWindowAv_a_T*/
...
#ifndef typedef_dsp_simulink_MovingAverage_a_T
#define typedef_dsp_simulink_MovingAverage_a_T
...
typedef struct {
  ...
  boolean_T TunablePropsChanged;
  cell_wrap_SpeedgoatCANOpen2Bu_T inputVarSize;
  dsp_private_SlidingWindowAv_a_T *pStatistic;
  int32_T NumChannels;
} dsp_simulink_MovingAverage_a_T;

#endif                                 /*typedef_dsp_simulink_MovingAverage_a_T*/
...
typedef struct P_SpeedgoatCANOpen2Buses1ms_T_ P_SpeedgoatCANOpen2Buses1ms_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_SpeedgoatCANOpen2Buses1ms_T
  RT_MODEL_SpeedgoatCANOpen2Buses1ms_T;

#endif                                 /* RTW_HEADER_SpeedgoatCANOpen2Buses1ms_types_h_ */
