 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 02 19:56:45 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME RPDOs_DunkC
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void RPDOs_DunkC_Outputs_wrapper(uint16_T *StatusWord,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    RPDOs_DunkC_Outputs_wrapper(StatusWord, OperationMode, CurrentActualValue, ActualTorque, ActualPosition, ActualVelocity);
