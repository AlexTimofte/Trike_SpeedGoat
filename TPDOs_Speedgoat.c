 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 16 19:11:27 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TPDOs_Speedgoat
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        DunkA_ControlWord
...
/* Input Port  1 */
#define IN_PORT_1_NAME        DunkA_OperationMode
...
/* Input Port  2 */
#define IN_PORT_2_NAME        DunkA_BrakeControl
...
/* Input Port  3 */
#define IN_PORT_3_NAME        DunkA_TargetPosition
...
/* Input Port  4 */
#define IN_PORT_4_NAME        DunkA_TargetVelocity
...
{
    const uint16_T *DunkA_ControlWord = (uint16_T *) ssGetInputPortRealSignal(S, 0);
    const int8_T *DunkA_OperationMode = (int8_T *) ssGetInputPortRealSignal(S, 1);
    const int16_T *DunkA_BrakeControl = (int16_T *) ssGetInputPortRealSignal(S, 2);
    const int32_T *DunkA_TargetPosition = (int32_T *) ssGetInputPortRealSignal(S, 3);
    const int32_T *DunkA_TargetVelocity = (int32_T *) ssGetInputPortRealSignal(S, 4);

    TPDOs_Speedgoat_Outputs_wrapper(DunkA_ControlWord, DunkA_OperationMode, DunkA_BrakeControl, DunkA_TargetPosition, DunkA_TargetVelocity);
