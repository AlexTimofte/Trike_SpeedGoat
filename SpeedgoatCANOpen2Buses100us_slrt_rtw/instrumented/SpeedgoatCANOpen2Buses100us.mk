...
MASTER_ANCHOR_DIR = 
START_DIR       = E:\SpeedGoat\Git\Trike_100us_develop_algo_5ms
...
MODELLIB                  = SpeedgoatCANOpen2Buses100uslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SpeedgoatCANOpen2Buses100us_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\SpeedgoatCANOpen2Buses100us_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
...
{C:\ProgramData\Speedgoat\speedgoatlib\R2018b\8.28.4\sg_blocks\can\src}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{C:\Users\Venqo\Desktop\SpeedGoat\Applications\Trike_git\Trike_SpeedGoat_algo}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
{E:\SpeedGoat\Git\Trike_100us_develop_algo}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
...
{C:\Users\Venqo\Desktop\SpeedGoat\Applications\Trike_git\Trike_SpeedGoat_algo}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<

{E:\SpeedGoat\Git\Trike_100us_develop_algo}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
