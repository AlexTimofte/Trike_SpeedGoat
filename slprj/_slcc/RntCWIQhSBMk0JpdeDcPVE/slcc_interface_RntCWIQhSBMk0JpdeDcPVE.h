...
DLL_EXPORT_CC extern void CANOpenSlave_ProcessStack_RntCWIQhSBMk0JpdeDcPVE(uint32_T rxID, uint8_T rxDLC, const uint8_T *rxData, uint32_T *txID, uint8_T *txDLC, uint8_T *txData, uint8_T *inData, uint8_T *outData);
