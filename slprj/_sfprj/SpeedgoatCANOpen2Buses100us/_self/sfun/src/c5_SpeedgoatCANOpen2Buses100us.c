...
#define c5_IN_Retract                  ((uint8_T)2U)
...
static void initialize_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void initialize_params_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void enable_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void disable_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void ext_mode_exec_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void set_sim_state_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray *
   c5_st);
static void c5_set_sim_state_side_effects_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void finalize_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void sf_gateway_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void mdl_start_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void initSimStructsc5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct
...
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static real32_T c5_d_emlrt_marshallIn
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray *
   c5_b_Br_CurrentReq, const char_T *c5_identifier);
static real32_T c5_e_emlrt_marshallIn
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray *
   c5_u, const emlrtMsgIdentifier *c5_parentId);
...
static uint8_T c5_f_emlrt_marshallIn
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray *
   c5_b_is_active_c5_SpeedgoatCANOpen2Buses100us, const char_T *c5_identifier);
...
static uint16_T c5_i_emlrt_marshallIn
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray *
   c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_j_emlrt_marshallIn(SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct
  *chartInstance, const mxArray *c5_b_dataWrittenToVector, const char_T
  *c5_identifier, boolean_T c5_y[1]);
static void c5_k_emlrt_marshallIn(SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
  boolean_T c5_y[1]);
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, int32_T
   c5_ssid);
static void c5_init_sf_message_store_memory
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void init_dsm_address_info(SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct
  *chartInstance);
  ...
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc5_SpeedgoatCANOpen2Buses100us(chartInstance);
  ...
  *chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses100us = 0U;
  *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us = c5_IN_NO_ACTIVE_CHILD;
  ...
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses100us == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 4U, *chartInstance->c5_sfEvent);
  }

  if (*chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us == c5_IN_Init) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
  }

  if (*chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us == c5_IN_Retract) {
...
static void ext_mode_exec_c5_SpeedgoatCANOpen2Buses100us
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  c5_update_debugger_state_c5_SpeedgoatCANOpen2Buses100us(chartInstance);
}
  ...
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  c5_hoistedGlobal = *chartInstance->c5_Br_CurrentReq;
  c5_b_y = NULL;
  sf_mex_assign(&c5_b_y, sf_mex_create("y", &c5_hoistedGlobal, 1, 0U, 0U, 0U, 0),
                false);
  sf_mex_setcell(c5_y, 0, c5_b_y);
  c5_b_hoistedGlobal =
    *chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses100us;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c5_y, 1, c5_c_y);
  c5_c_hoistedGlobal = *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us;
  c5_d_y = NULL;
  sf_mex_assign(&c5_d_y, sf_mex_create("y", &c5_c_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
   ...
   c5_st)
{
  ...
  *chartInstance->c5_Br_CurrentReq = c5_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 0)), "Br_CurrentReq");
  *chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses100us =
    c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
    "is_active_c5_SpeedgoatCANOpen2Buses100us");
  *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us = c5_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 2)),
     "is_c5_SpeedgoatCANOpen2Buses100us");
  ...
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  if (chartInstance->c5_doSetSimStateSideEffects != 0) {
    if ((*chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us == c5_IN_Retract) &&
        (sf_mex_sub(chartInstance->c5_setSimStateSideEffectsInfo,
  ...
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  boolean_T c5_out;
  boolean_T c5_b_out;
  uint32_T c5_c_debug_family_var_map[2];
  real_T c5_c_nargin = 0.0;
  real_T c5_c_nargout = 0.0;
  uint32_T c5_d_debug_family_var_map[2];
  real_T c5_d_nargin = 0.0;
  real_T c5_d_nargout = 0.0;
  uint32_T c5_e_debug_family_var_map[2];
  real_T c5_e_nargin = 0.0;
  real_T c5_e_nargout = 0.0;
  c5_set_sim_state_side_effects_c5_SpeedgoatCANOpen2Buses100us(chartInstance);
  ...
  *chartInstance->c5_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses100us == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 4U, *chartInstance->c5_sfEvent);
    *chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses100us = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 4U, *chartInstance->c5_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
    *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us = c5_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_c_nargout, 1U, c5_sf_marshallOut,
      c5_sf_marshallIn);
    *chartInstance->c5_Br_CurrentReq = 0.0F;
    chartInstance->c5_dataWrittenToVector[0U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c5_Br_CurrentReq, 2U);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
    switch (*chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us) {
     case c5_IN_Init:
      CV_CHART_EVAL(4, 0, c5_IN_Init);
      ...
      if (CV_EML_IF(1, 0, 0, CV_RELATIONAL_EVAL(5U, 1U, 0, (real_T)
            *chartInstance->c5_PedalTravelGradient, 0.05, -1, 4U, (real_T)
            *chartInstance->c5_PedalTravelGradient > 0.05))) {
        c5_out = true;
      } else {
        c5_out = false;
      }
      ...
      if (c5_out) {
        ...
        *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us =
          c5_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us = c5_IN_Retract;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_temporalCounter_i1 = 0U;
      } else {
     ...
     case c5_IN_Retract:
      CV_CHART_EVAL(4, 0, c5_IN_Retract);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance;
  chartInstance = (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *)
    chartInstanceVoid;
  ...
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  ...
  c5_y = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_nargin), &c5_thisId);
...
const mxArray *sf_c5_SpeedgoatCANOpen2Buses100us_get_eml_resolved_functions_info
  (void)
{
   ...
   c5_b_Br_CurrentReq, const char_T *c5_identifier)
{
  ...
  c5_thisId.fParent = NULL;
  c5_thisId.bParentIsCell = false;
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_Br_CurrentReq),
    &c5_thisId);
  sf_mex_destroy(&c5_b_Br_CurrentReq);
  return c5_y;
}
...
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData)
{
  const mxArray *c5_b_Br_CurrentReq;
  const char_T *c5_identifier;
  emlrtMsgIdentifier c5_thisId;
  real32_T c5_y;
  SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance;
  chartInstance = (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *)
    chartInstanceVoid;
  c5_b_Br_CurrentReq = sf_mex_dup(c5_mxArrayInData);
  c5_identifier = c5_varName;
  c5_thisId.fIdentifier = (const char *)c5_identifier;
  c5_thisId.fParent = NULL;
  c5_thisId.bParentIsCell = false;
   ...
   c5_b_is_active_c5_SpeedgoatCANOpen2Buses100us, const char_T *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_SpeedgoatCANOpen2Buses100us), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_SpeedgoatCANOpen2Buses100us);
  return c5_y;
}
  ...
  (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses100us = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses100us = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 2);
  chartInstance->c5_PedalTravelGradient = (real32_T *)
    ssGetInputPortSignal_wrapper(chartInstance->S, 0);
  chartInstance->c5_Br_CurrentReq = (real32_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
...
void sf_c5_SpeedgoatCANOpen2Buses100us_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_SpeedgoatCANOpen2Buses100us_get_post_codegen_info(void);
mxArray *sf_c5_SpeedgoatCANOpen2Buses100us_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c5_SpeedgoatCANOpen2Buses100us_get_post_codegen_info();
...
mxArray *sf_c5_SpeedgoatCANOpen2Buses100us_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_SpeedgoatCANOpen2Buses100us_jit_fallback_info(void)
{
...
mxArray *sf_c5_SpeedgoatCANOpen2Buses100us_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_SpeedgoatCANOpen2Buses100us(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[234],T\"Br_CurrentReq\",},{M[8],M[0],T\"is_active_c5_SpeedgoatCANOpen2Buses100us\",},{M[9],M[0],T\"is_c5_SpeedgoatCANOpen2Buses100us\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[79],M[1]}}},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_SpeedgoatCANOpen2Buses100us_get_check_sum(&mxChecksum);
  ...
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg
    ( (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *) chartInstance, msgSSID);
}
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          sf_debug_set_chart_event_thresholds(sfGlobalDebugInstanceStruct,
            ...
            0,
            0);
          _SFD_SET_DATA_PROPS(0,1,1,0,"PedalTravelGradient");
          _SFD_SET_DATA_PROPS(1,1,1,0,"PedalTravel");
          _SFD_SET_DATA_PROPS(2,2,0,1,"Br_CurrentReq");
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c5_PedalTravelGradient);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c5_Br_CurrentReq);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c5_PedalTravel);
      }
    }
  }
}
...
static void sf_opaque_initialize_c5_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
  initialize_c5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  enable_c5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  disable_c5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  sf_gateway_c5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c5_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  ext_mode_exec_c5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_SpeedgoatCANOpen2Buses100us
  (SimStruct* S)
{
  return get_sim_state_c5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *)sf_get_chart_instance_ptr
     (S));                             /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_SpeedgoatCANOpen2Buses100us(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*)sf_get_chart_instance_ptr
     (S), st);
}

static void sf_opaque_terminate_c5_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c5_SpeedgoatCANOpen2Buses100us
      ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_SpeedgoatCANOpen2Buses100us
    ((SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  int i;
...
mxArray *sf_c5_SpeedgoatCANOpen2Buses100us_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c5_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
...
static void mdlRTW_c5_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance;
  chartInstance = (SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct *)utMalloc
    (sizeof(SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc5_SpeedgoatCANOpen2Buses100usInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c5_SpeedgoatCANOpen2Buses100us;
  ...
  mdl_start_c5_SpeedgoatCANOpen2Buses100us(chartInstance);
}

void c5_SpeedgoatCANOpen2Buses100us_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_SpeedgoatCANOpen2Buses100us(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_SpeedgoatCANOpen2Buses100us(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_SpeedgoatCANOpen2Buses100us(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_SpeedgoatCANOpen2Buses100us_method_dispatcher.\n"
