...
static void c2_enter_atomic_Init(SFc2_SpeedgoatCANOpen2Buses100usInstanceStruct *
  chartInstance);
static void c2_enter_atomic_Wait(SFc2_SpeedgoatCANOpen2Buses100usInstanceStruct *
  chartInstance);
    ...
    switch (*chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses100us) {
     case c2_IN_Clear_Error:
      ...
      if (CV_EML_IF(2, 0, 0, CV_RELATIONAL_EVAL(5U, 2U, 0, (real_T)
            *chartInstance->c2_aux, 40000.0, -1, 4U, *chartInstance->c2_aux >
            40000.0F))) {
        c2_out = true;
      } else {
        c2_out = false;
  ...
  chartInstance)
{
  ...
  *chartInstance->c2_BrakeCtrl = 2.0F;
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c2_BrakeCtrl, 6U);
  if (!chartInstance->c2_dataWrittenToVector[4U]) {
    sf_read_before_write_error(chartInstance->S, 0U, 238U, 31, 3);
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2250828583U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(565573265U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1682779051U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(570672084U);
}
...
mxArray *sf_c2_SpeedgoatCANOpen2Buses100us_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("O4LWzMdDcRceb04oyQMYXC");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_RELATIONAL(3,0,0,1,7,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(3,0,1,11,25,-1,0);
...

        {
          ...
          static int condEnd[] = { 8, 26 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(4,0,0,1,26,2,0,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML_RELATIONAL(4,0,0,1,8,-1,5);
        _SFD_CV_INIT_EML_RELATIONAL(4,0,1,12,26,-1,0);
...
static void mdlSetWorkWidths_c2_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4284876969U));
  ssSetChecksum1(S,(1502803793U));
  ssSetChecksum2(S,(1584436795U));
  ssSetChecksum3(S,(3594472552U));
