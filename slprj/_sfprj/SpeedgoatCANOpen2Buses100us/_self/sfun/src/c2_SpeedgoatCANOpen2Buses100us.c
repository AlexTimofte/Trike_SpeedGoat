...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2075841097U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3725734783U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(303210497U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2528690903U);
}
...
mxArray *sf_c2_SpeedgoatCANOpen2Buses100us_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("y4IkQUXHWjOPFHfjmNNr6F");
...
static void mdlSetWorkWidths_c2_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1875239408U));
  ssSetChecksum1(S,(2810041039U));
  ssSetChecksum2(S,(3616530586U));
  ssSetChecksum3(S,(3733549842U));
