...
#define c12_IN_SetVelocity             ((uint8_T)4U)
#define c12_IN_Wait                    ((uint8_T)5U)
...
static const char * c12_f_debug_family_names[3] = { "nargin", "nargout",
...
static const char * c12_j_debug_family_names[3] = { "nargin", "nargout",
  "sf_internal_predicateOutput" };

/* Function Declarations */
static void initialize_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void initialize_params_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void enable_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void disable_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void ext_mode_exec_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void set_sim_state_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray
   *c12_st);
static void c12_set_sim_state_side_effects_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void finalize_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void sf_gateway_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void mdl_start_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void c12_chartstep_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
...
static uint8_T c12_f_emlrt_marshallIn
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray
   *c12_b_is_active_c12_SpeedgoatCANOpen2Buses100us, const char_T
   *c12_identifier);
...
static void c12_h_emlrt_marshallIn
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray
   *c12_b_dataWrittenToVector, const char_T *c12_identifier, boolean_T c12_y[8]);
static void c12_i_emlrt_marshallIn
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray
   *c12_u, const emlrtMsgIdentifier *c12_parentId, boolean_T c12_y[8]);
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, int32_T
   c12_ssid);
  ...
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc12_SpeedgoatCANOpen2Buses100us(chartInstance);
  ...
  *chartInstance->c12_is_active_c12_SpeedgoatCANOpen2Buses100us = 0U;
  ...
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c12_is_active_c12_SpeedgoatCANOpen2Buses100us == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 4U, *chartInstance->c12_sfEvent);
  }
  ...
  if (*chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us ==
      c12_IN_Clear_Error) {
  ...
  if (*chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us == c12_IN_Wait) {
...
static void ext_mode_exec_c12_SpeedgoatCANOpen2Buses100us
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  c12_update_debugger_state_c12_SpeedgoatCANOpen2Buses100us(chartInstance);
}
  ...
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  c12_st = NULL;
  c12_y = NULL;
  sf_mex_assign(&c12_y, sf_mex_createcellmatrix(11, 1), false);
  ...
  c12_d_hoistedGlobal = *chartInstance->c12_PowerEnable;
  c12_e_y = NULL;
  sf_mex_assign(&c12_e_y, sf_mex_create("y", &c12_d_hoistedGlobal, 1, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c12_y, 3, c12_e_y);
  c12_e_hoistedGlobal = *chartInstance->c12_SpeedRequest;
  c12_f_y = NULL;
  ...
  c12_h_hoistedGlobal = *chartInstance->c12_enable;
  c12_i_y = NULL;
  sf_mex_assign(&c12_i_y, sf_mex_create("y", &c12_h_hoistedGlobal, 1, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c12_y, 7, c12_i_y);
  c12_i_hoistedGlobal =
    *chartInstance->c12_is_active_c12_SpeedgoatCANOpen2Buses100us;
  c12_j_y = NULL;
  sf_mex_assign(&c12_j_y, sf_mex_create("y", &c12_i_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c12_y, 8, c12_j_y);
  c12_j_hoistedGlobal = *chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us;
  c12_k_y = NULL;
  sf_mex_assign(&c12_k_y, sf_mex_create("y", &c12_j_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c12_y, 9, c12_k_y);
  c12_l_y = NULL;
  sf_mex_assign(&c12_l_y, sf_mex_create("y",
    chartInstance->c12_dataWrittenToVector, 11, 0U, 1U, 0U, 1, 8), false);
   ...
   *c12_st)
{
  ...
  *chartInstance->c12_PowerEnable = c12_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c12_u, 3)), "PowerEnable");
  *chartInstance->c12_SpeedRequest = c12_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c12_u, 4)), "SpeedRequest");
  ...
  *chartInstance->c12_enable = c12_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c12_u, 7)), "enable");
  *chartInstance->c12_is_active_c12_SpeedgoatCANOpen2Buses100us =
    c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 8)),
    "is_active_c12_SpeedgoatCANOpen2Buses100us");
  *chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us =
    c12_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 9)),
    "is_c12_SpeedgoatCANOpen2Buses100us");
  c12_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c12_u, 10)),
  ...
  sf_mex_assign(&chartInstance->c12_setSimStateSideEffectsInfo,
    ...
    (c12_u, 11)), "setSimStateSideEffectsInfo"), true);
  ...
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 4, *chartInstance->c12_sfEvent);
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_Joystick_LongCmd, 6U);
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_ReadError, 5U);
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_Joystick_LatCmd, 4U);
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_ButtonStatus, 3U);
  *chartInstance->c12_sfEvent = CALL_EVENT;
  c12_chartstep_c12_SpeedgoatCANOpen2Buses100us(chartInstance);
  ...
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  uint32_T c12_g_debug_family_var_map[2];
  real_T c12_g_nargin = 0.0;
  uint32_T c12_h_debug_family_var_map[2];
  real_T c12_g_nargout = 0.0;
  real_T c12_h_nargin = 0.0;
  real_T c12_h_nargout = 0.0;
  uint32_T c12_i_debug_family_var_map[3];
  uint32_T c12_j_debug_family_var_map[2];
  real_T c12_i_nargin = 0.0;
  real_T c12_j_nargin = 0.0;
  real_T c12_i_nargout = 1.0;
  real_T c12_j_nargout = 0.0;
  boolean_T c12_e_out;
  uint32_T c12_k_debug_family_var_map[2];
  ...
  if (*chartInstance->c12_is_active_c12_SpeedgoatCANOpen2Buses100us == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 4U, *chartInstance->c12_sfEvent);
    ...
    *chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us = c12_IN_Init;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_f_nargin, 0U, c12_sf_marshallOut,
      c12_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_f_nargout, 1U, c12_sf_marshallOut,
      c12_sf_marshallIn);
    *chartInstance->c12_ClearError = 0.0F;
    chartInstance->c12_dataWrittenToVector[0U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_ClearError, 7U);
    *chartInstance->c12_DeviceMode = 0.0F;
    chartInstance->c12_dataWrittenToVector[1U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_DeviceMode, 8U);
    *chartInstance->c12_BrakeCtrl = 0.0F;
    chartInstance->c12_dataWrittenToVector[2U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_BrakeCtrl, 9U);
    *chartInstance->c12_PowerEnable = 0.0F;
    chartInstance->c12_dataWrittenToVector[6U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_PowerEnable, 10U);
    *chartInstance->c12_SpeedRequest = 0.0F;
    chartInstance->c12_dataWrittenToVector[7U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_SpeedRequest, 11U);
    *chartInstance->c12_aux = 0.0F;
    ...
    switch (*chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us) {
     case c12_IN_Clear_Error:
      CV_CHART_EVAL(4, 0, c12_IN_Clear_Error);
      ...
      if (CV_EML_IF(2, 0, 0, CV_RELATIONAL_EVAL(5U, 2U, 0, (real_T)
            *chartInstance->c12_aux, 2000.0, -1, 4U, *chartInstance->c12_aux >
            2000.0F))) {
        c12_out = true;
      } else {
        c12_out = false;
      ...
      if (c12_out) {
        ...
        *chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us =
          c12_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c12_sfEvent);
        *chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us = c12_IN_Wait;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c12_sfEvent);
      ...
      *chartInstance->c12_BrakeCtrl = 0.0F;
      ...
      if (CV_EML_COND(1, 0, 0, CV_RELATIONAL_EVAL(5U, 1U, 0, (real_T)
            *chartInstance->c12_ButtonStatus, 1.0, -1, 0U,
            *chartInstance->c12_ButtonStatus == 1.0F)) || CV_EML_COND(1, 0, 1,
           CV_RELATIONAL_EVAL(5U, 1U, 1, (real_T)*chartInstance->c12_ReadError,
                              1.0, -1, 1U, *chartInstance->c12_ReadError != 1.0F)))
      {
     ...
     case c12_IN_SetCurrentMode:
      CV_CHART_EVAL(4, 0, c12_IN_SetCurrentMode);
      ...
      if (CV_EML_COND(5, 0, 0, CV_RELATIONAL_EVAL(5U, 5U, 0, (real_T)
            *chartInstance->c12_ButtonStatus, 8.0, -1, 0U,
            *chartInstance->c12_ButtonStatus == 8.0F)) && CV_EML_COND(5, 0, 1,
           CV_RELATIONAL_EVAL(5U, 5U, 1, (real_T)*chartInstance->c12_ReadError,
                              1.0, -1, 0U, *chartInstance->c12_ReadError == 1.0F)))
      {
      ...
      if (c12_b_out) {
        ...
        *chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us =
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_h_nargout, 1U,
          c12_sf_marshallOut, c12_sf_marshallIn);
        *chartInstance->c12_DeviceMode = 2.0F;
        chartInstance->c12_dataWrittenToVector[1U] = true;
        _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_DeviceMode, 8U);
     ...
     case c12_IN_SetVelocity:
      CV_CHART_EVAL(4, 0, c12_IN_SetVelocity);
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c12_c_nargout, 1U,
        c12_sf_marshallOut, c12_sf_marshallIn);
      c12_hoistedGlobal = *chartInstance->c12_Joystick_LongCmd;
      c12_a = c12_hoistedGlobal;
      *chartInstance->c12_SpeedRequest = c12_a * 20.0F;
      chartInstance->c12_dataWrittenToVector[7U] = true;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c12_SpeedRequest, 11U);
      _SFD_SYMBOL_SCOPE_POP();
      ...
      *chartInstance->c12_BrakeCtrl = 2.0F;
      ...
      if (CV_EML_COND(3, 0, 0, CV_RELATIONAL_EVAL(5U, 3U, 0, (real_T)
            *chartInstance->c12_ButtonStatus, 0.0, -1, 0U,
            *chartInstance->c12_ButtonStatus == 0.0F)) && CV_EML_COND(3, 0, 1,
           CV_RELATIONAL_EVAL(5U, 3U, 1, (real_T)*chartInstance->c12_ReadError,
                              1.0, -1, 0U, *chartInstance->c12_ReadError == 1.0F)))
      {
      ...
      if (c12_d_out) {
        ...
        *chartInstance->c12_aux = 0.0F;
        ...
        if (CV_EML_COND(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0, (real_T)
              *chartInstance->c12_ButtonStatus, 2.0, -1, 0U,
              *chartInstance->c12_ButtonStatus == 2.0F)) && CV_EML_COND(4, 0, 1,
             CV_RELATIONAL_EVAL(5U, 4U, 1, (real_T)*chartInstance->c12_ReadError,
              1.0, -1, 0U, *chartInstance->c12_ReadError == 1.0F))) {
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance;
  chartInstance = (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *)
    chartInstanceVoid;
   ...
   *c12_identifier)
{
  ...
  c12_y = c12_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c12_b_is_active_c12_SpeedgoatCANOpen2Buses100us), &c12_thisId);
  sf_mex_destroy(&c12_b_is_active_c12_SpeedgoatCANOpen2Buses100us);
  return c12_y;
}
   ...
   *c12_u, const emlrtMsgIdentifier *c12_parentId, boolean_T c12_y[8])
{
  ...
  int32_T c12_i2;
  (void)chartInstance;
  sf_mex_import(c12_parentId, sf_mex_dup(c12_u), c12_bv1, 1, 11, 0U, 1, 0U, 1, 8);
  for (c12_i2 = 0; c12_i2 < 8; c12_i2++) {
  ...
  (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_SpeedgoatCANOpen2Buses100us = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c12_is_c12_SpeedgoatCANOpen2Buses100us = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 2);
  chartInstance->c12_ButtonStatus = (real32_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c12_Joystick_LatCmd = (real32_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  ...
  chartInstance->c12_enable = (real32_T *)ssGetDWork_wrapper(chartInstance->S, 5);
  chartInstance->c12_PowerEnable = (real32_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c12_Joystick_LongCmd = (real32_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c12_SpeedRequest = (real32_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 5);
}
...
mxArray *sf_c12_SpeedgoatCANOpen2Buses100us_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c12_SpeedgoatCANOpen2Buses100us_get_post_codegen_info();
...
mxArray *sf_c12_SpeedgoatCANOpen2Buses100us_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_SpeedgoatCANOpen2Buses100us_jit_fallback_info(void)
{
...
mxArray *sf_c12_SpeedgoatCANOpen2Buses100us_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_SpeedgoatCANOpen2Buses100us(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[36],T\"BrakeCtrl\",},{M[1],M[3],T\"ClearError\",},{M[1],M[71],T\"DeviceMode\",},{M[1],M[234],T\"PowerEnable\",},{M[1],M[249],T\"SpeedRequest\",},{M[3],M[70],T\"aux\",},{M[3],M[51],T\"aux2\",},{M[3],M[174],T\"enable\",},{M[8],M[0],T\"is_active_c12_SpeedgoatCANOpen2Buses100us\",},{M[9],M[0],T\"is_c12_SpeedgoatCANOpen2Buses100us\",}}",
  ...
  sf_c12_SpeedgoatCANOpen2Buses100us_get_check_sum(&mxChecksum);
  ...
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg
    ( (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *) chartInstance, msgSSID);
}
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c12_ButtonStatus);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c12_Joystick_LatCmd);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c12_ClearError);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c12_DeviceMode);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c12_BrakeCtrl);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c12_ReadError);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c12_aux2);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c12_aux);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c12_enable);
        _SFD_SET_DATA_VALUE_PTR(10U, chartInstance->c12_PowerEnable);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c12_Joystick_LongCmd);
        _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c12_SpeedRequest);
      }
    }
  }
}
...
static void sf_opaque_initialize_c12_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
  initialize_c12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  enable_c12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  disable_c12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  sf_gateway_c12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c12_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  ext_mode_exec_c12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_SpeedgoatCANOpen2Buses100us
  (SimStruct* S)
{
  return get_sim_state_c12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *)
     sf_get_chart_instance_ptr(S));    /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_SpeedgoatCANOpen2Buses100us(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*)sf_get_chart_instance_ptr
     (S), st);
}

static void sf_opaque_terminate_c12_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c12_SpeedgoatCANOpen2Buses100us
      ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_SpeedgoatCANOpen2Buses100us
    ((SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  int i;
...
mxArray *sf_c12_SpeedgoatCANOpen2Buses100us_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c12_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
...
static void mdlRTW_c12_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance;
  chartInstance = (SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct *)utMalloc
    (sizeof(SFc12_SpeedgoatCANOpen2Buses100usInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c12_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c12_SpeedgoatCANOpen2Buses100us;
  ...
  mdl_start_c12_SpeedgoatCANOpen2Buses100us(chartInstance);
}

void c12_SpeedgoatCANOpen2Buses100us_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_SpeedgoatCANOpen2Buses100us(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_SpeedgoatCANOpen2Buses100us(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_SpeedgoatCANOpen2Buses100us(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_SpeedgoatCANOpen2Buses100us_method_dispatcher.\n"
