...
#define c1_IN_SetVelocity              ((uint8_T)4U)
#define c1_IN_Wait                     ((uint8_T)5U)
...
static void initialize_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void initialize_params_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void enable_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void disable_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void ext_mode_exec_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void set_sim_state_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray *
   c1_st);
static void c1_set_sim_state_side_effects_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void finalize_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void sf_gateway_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void mdl_start_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void c1_chartstep_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void initSimStructsc1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct
...
static uint8_T c1_f_emlrt_marshallIn
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray *
   c1_b_is_active_c1_SpeedgoatCANOpen2Buses100us, const char_T *c1_identifier);
static uint8_T c1_g_emlrt_marshallIn
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, const mxArray *
   c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_h_emlrt_marshallIn(SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct
  *chartInstance, const mxArray *c1_b_dataWrittenToVector, const char_T
  *c1_identifier, boolean_T c1_y[8]);
static void c1_i_emlrt_marshallIn(SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  boolean_T c1_y[8]);
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance, int32_T
   c1_ssid);
static void c1_init_sf_message_store_memory
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void init_dsm_address_info(SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct
  *chartInstance);
  ...
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_SpeedgoatCANOpen2Buses100us(chartInstance);
  ...
  *chartInstance->c1_is_active_c1_SpeedgoatCANOpen2Buses100us = 0U;
  *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us = c1_IN_NO_ACTIVE_CHILD;
  ...
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c1_is_active_c1_SpeedgoatCANOpen2Buses100us == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
  }

  if (*chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us == c1_IN_Init) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c1_sfEvent);
  }

  if (*chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us == c1_IN_Clear_Error)
  {
  ...
  if (*chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us == c1_IN_Wait) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 4U, *chartInstance->c1_sfEvent);
  }

  if (*chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us ==
  ...
  if (*chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us == c1_IN_SetVelocity)
  {
...
static void ext_mode_exec_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  c1_update_debugger_state_c1_SpeedgoatCANOpen2Buses100us(chartInstance);
}
  ...
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  c1_d_hoistedGlobal = *chartInstance->c1_PowerEnable;
  c1_e_y = NULL;
  sf_mex_assign(&c1_e_y, sf_mex_create("y", &c1_d_hoistedGlobal, 1, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c1_y, 3, c1_e_y);
  c1_e_hoistedGlobal = *chartInstance->c1_SpeedRequest;
  c1_f_y = NULL;
  ...
  c1_h_hoistedGlobal = *chartInstance->c1_enable;
  c1_i_y = NULL;
  sf_mex_assign(&c1_i_y, sf_mex_create("y", &c1_h_hoistedGlobal, 1, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c1_y, 7, c1_i_y);
  c1_i_hoistedGlobal =
    *chartInstance->c1_is_active_c1_SpeedgoatCANOpen2Buses100us;
  c1_j_y = NULL;
  sf_mex_assign(&c1_j_y, sf_mex_create("y", &c1_i_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c1_y, 8, c1_j_y);
  c1_j_hoistedGlobal = *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us;
  c1_k_y = NULL;
  sf_mex_assign(&c1_k_y, sf_mex_create("y", &c1_j_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c1_y, 9, c1_k_y);
  c1_l_y = NULL;
  sf_mex_assign(&c1_l_y, sf_mex_create("y",
    chartInstance->c1_dataWrittenToVector, 11, 0U, 1U, 0U, 1, 8), false);
   ...
   c1_st)
{
  ...
  *chartInstance->c1_PowerEnable = c1_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 3)), "PowerEnable");
  *chartInstance->c1_SpeedRequest = c1_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 4)), "SpeedRequest");
  ...
  *chartInstance->c1_enable = c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c1_u, 7)), "enable");
  *chartInstance->c1_is_active_c1_SpeedgoatCANOpen2Buses100us =
    c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 8)),
    "is_active_c1_SpeedgoatCANOpen2Buses100us");
  *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us = c1_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 9)),
     "is_c1_SpeedgoatCANOpen2Buses100us");
  c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 10)),
...
static void sf_gateway_c1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  c1_set_sim_state_side_effects_c1_SpeedgoatCANOpen2Buses100us(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0, *chartInstance->c1_sfEvent);
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_Joystick_LongCmd, 6U);
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_ReadError, 5U);
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_Joystick_LatCmd, 4U);
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_ButtonStatus, 3U);
  *chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_SpeedgoatCANOpen2Buses100us(chartInstance);
  ...
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  uint32_T c1_c_debug_family_var_map[2];
  real_T c1_nargin = 0.0;
  real_T c1_b_nargin = 0.0;
  real_T c1_c_nargin = 0.0;
  real_T c1_nargout = 1.0;
  uint32_T c1_d_debug_family_var_map[3];
  ...
  if (*chartInstance->c1_is_active_c1_SpeedgoatCANOpen2Buses100us == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_active_c1_SpeedgoatCANOpen2Buses100us = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us = c1_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c1_sfEvent);
    ...
    *chartInstance->c1_ClearError = 0.0F;
    ...
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_ClearError, 7U);
    *chartInstance->c1_DeviceMode = 0.0F;
    chartInstance->c1_dataWrittenToVector[1U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_DeviceMode, 8U);
    *chartInstance->c1_BrakeCtrl = 0.0F;
    chartInstance->c1_dataWrittenToVector[2U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_BrakeCtrl, 9U);
    *chartInstance->c1_PowerEnable = 0.0F;
    chartInstance->c1_dataWrittenToVector[6U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_PowerEnable, 10U);
    *chartInstance->c1_SpeedRequest = 0.0F;
    chartInstance->c1_dataWrittenToVector[7U] = true;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_SpeedRequest, 11U);
    *chartInstance->c1_aux = 0.0F;
    ...
    switch (*chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us) {
     case c1_IN_Clear_Error:
      ...
      if (CV_EML_IF(2, 0, 0, CV_RELATIONAL_EVAL(5U, 2U, 0, (real_T)
            *chartInstance->c1_aux, 2000.0, -1, 4U, *chartInstance->c1_aux >
            2000.0F))) {
        c1_out = true;
      } else {
        c1_out = false;
      ...
      if (c1_out) {
        ...
        *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us =
          c1_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
        *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us = c1_IN_Wait;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 4U, *chartInstance->c1_sfEvent);
      ...
      *chartInstance->c1_BrakeCtrl = 0.0F;
      ...
      if (CV_EML_COND(1, 0, 0, CV_RELATIONAL_EVAL(5U, 1U, 0, (real_T)
            *chartInstance->c1_ButtonStatus, 1.0, -1, 0U,
            *chartInstance->c1_ButtonStatus == 1.0F)) || CV_EML_COND(1, 0, 1,
           CV_RELATIONAL_EVAL(5U, 1U, 1, (real_T)*chartInstance->c1_ReadError,
                              1.0, -1, 1U, *chartInstance->c1_ReadError != 1.0F)))
      {
      ...
      if (c1_c_out) {
        ...
        *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us =
          c1_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c1_sfEvent);
        *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us = c1_IN_Clear_Error;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
      } else {
     ...
     case c1_IN_SetCurrentMode:
      ...
      if (CV_EML_COND(5, 0, 0, CV_RELATIONAL_EVAL(5U, 5U, 0, (real_T)
            *chartInstance->c1_ButtonStatus, 8.0, -1, 0U,
            *chartInstance->c1_ButtonStatus == 8.0F)) && CV_EML_COND(5, 0, 1,
           CV_RELATIONAL_EVAL(5U, 5U, 1, (real_T)*chartInstance->c1_ReadError,
                              1.0, -1, 0U, *chartInstance->c1_ReadError == 1.0F)))
      {
      ...
      if (c1_b_out) {
        ...
        *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us =
          c1_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c1_sfEvent);
        *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us = c1_IN_SetVelocity;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c1_sfEvent);
      } else {
     ...
     case c1_IN_SetVelocity:
      CV_CHART_EVAL(0, 0, c1_IN_SetVelocity);
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_c_nargout, 1U, c1_sf_marshallOut,
        c1_sf_marshallIn);
      c1_hoistedGlobal = *chartInstance->c1_Joystick_LongCmd;
      c1_a = c1_hoistedGlobal;
      *chartInstance->c1_SpeedRequest = c1_a * 20.0F;
      chartInstance->c1_dataWrittenToVector[7U] = true;
      _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c1_SpeedRequest, 11U);
      _SFD_SYMBOL_SCOPE_POP();
      ...
      *chartInstance->c1_BrakeCtrl = 2.0F;
      ...
      if (CV_EML_COND(3, 0, 0, CV_RELATIONAL_EVAL(5U, 3U, 0, (real_T)
            *chartInstance->c1_ButtonStatus, 0.0, -1, 0U,
            *chartInstance->c1_ButtonStatus == 0.0F)) && CV_EML_COND(3, 0, 1,
           CV_RELATIONAL_EVAL(5U, 3U, 1, (real_T)*chartInstance->c1_ReadError,
                              1.0, -1, 0U, *chartInstance->c1_ReadError == 1.0F)))
      {
      ...
      if (c1_d_out) {
        ...
        *chartInstance->c1_aux = 0.0F;
        ...
        if (CV_EML_COND(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0, (real_T)
              *chartInstance->c1_ButtonStatus, 2.0, -1, 0U,
              *chartInstance->c1_ButtonStatus == 2.0F)) && CV_EML_COND(4, 0, 1,
             CV_RELATIONAL_EVAL(5U, 4U, 1, (real_T)*chartInstance->c1_ReadError,
              1.0, -1, 0U, *chartInstance->c1_ReadError == 1.0F))) {
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance;
  chartInstance = (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c1_SpeedgoatCANOpen2Buses100us_get_eml_resolved_functions_info
  (void)
{
   ...
   c1_b_is_active_c1_SpeedgoatCANOpen2Buses100us, const char_T *c1_identifier)
{
  ...
  c1_y = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_SpeedgoatCANOpen2Buses100us), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_SpeedgoatCANOpen2Buses100us);
  return c1_y;
}
  ...
  boolean_T c1_y[8])
{
  ...
  int32_T c1_i2;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_bv1, 1, 11, 0U, 1, 0U, 1, 8);
  ...
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_SpeedgoatCANOpen2Buses100us = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 2);
  chartInstance->c1_ButtonStatus = (real32_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c1_Joystick_LatCmd = (real32_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  ...
  chartInstance->c1_enable = (real32_T *)ssGetDWork_wrapper(chartInstance->S, 5);
  chartInstance->c1_PowerEnable = (real32_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c1_Joystick_LongCmd = (real32_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c1_SpeedRequest = (real32_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 5);
}
...
mxArray *sf_c1_SpeedgoatCANOpen2Buses100us_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c1_SpeedgoatCANOpen2Buses100us_get_post_codegen_info();
...
mxArray *sf_c1_SpeedgoatCANOpen2Buses100us_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_SpeedgoatCANOpen2Buses100us_jit_fallback_info(void)
{
...
mxArray *sf_c1_SpeedgoatCANOpen2Buses100us_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_SpeedgoatCANOpen2Buses100us(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[36],T\"BrakeCtrl\",},{M[1],M[3],T\"ClearError\",},{M[1],M[71],T\"DeviceMode\",},{M[1],M[234],T\"PowerEnable\",},{M[1],M[249],T\"SpeedRequest\",},{M[3],M[70],T\"aux\",},{M[3],M[51],T\"aux2\",},{M[3],M[174],T\"enable\",},{M[8],M[0],T\"is_active_c1_SpeedgoatCANOpen2Buses100us\",},{M[9],M[0],T\"is_c1_SpeedgoatCANOpen2Buses100us\",}}",
  ...
  sf_c1_SpeedgoatCANOpen2Buses100us_get_check_sum(&mxChecksum);
  ...
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg
    ( (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *) chartInstance, msgSSID);
}
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c1_ButtonStatus);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c1_Joystick_LatCmd);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c1_ClearError);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c1_DeviceMode);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c1_BrakeCtrl);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c1_ReadError);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c1_aux2);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c1_aux);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c1_enable);
        _SFD_SET_DATA_VALUE_PTR(10U, chartInstance->c1_PowerEnable);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c1_Joystick_LongCmd);
        _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c1_SpeedRequest);
      }
    }
  }
}
...
static void sf_opaque_initialize_c1_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
  initialize_c1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  enable_c1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  disable_c1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  sf_gateway_c1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c1_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  ext_mode_exec_c1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_SpeedgoatCANOpen2Buses100us
  (SimStruct* S)
{
  return get_sim_state_c1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *)sf_get_chart_instance_ptr
     (S));                             /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_SpeedgoatCANOpen2Buses100us(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*)sf_get_chart_instance_ptr
     (S), st);
}

static void sf_opaque_terminate_c1_SpeedgoatCANOpen2Buses100us(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c1_SpeedgoatCANOpen2Buses100us
      ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_SpeedgoatCANOpen2Buses100us
    ((SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  int i;
...
mxArray *sf_c1_SpeedgoatCANOpen2Buses100us_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c1_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
...
static void mdlRTW_c1_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance;
  chartInstance = (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *)utMalloc
    (sizeof(SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_SpeedgoatCANOpen2Buses100us;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c1_SpeedgoatCANOpen2Buses100us;
  ...
  mdl_start_c1_SpeedgoatCANOpen2Buses100us(chartInstance);
}

void c1_SpeedgoatCANOpen2Buses100us_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_SpeedgoatCANOpen2Buses100us(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_SpeedgoatCANOpen2Buses100us(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_SpeedgoatCANOpen2Buses100us(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_SpeedgoatCANOpen2Buses100us_method_dispatcher.\n"
