...
static void initSimStructsc1_SpeedgoatCANOpen2Buses100us
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance);
static void c1_enter_atomic_Init(SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *
  chartInstance);
  ...
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  c1_i_hoistedGlobal = *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses100us;
  c1_j_y = NULL;
  ...
  (SFc1_SpeedgoatCANOpen2Buses100usInstanceStruct *chartInstance)
{
  ...
  uint32_T c1_j_debug_family_var_map[3];
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3123063238U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2214170789U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1145865758U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(215976638U);
}
...
mxArray *sf_c1_SpeedgoatCANOpen2Buses100us_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("t0McdRE9w8jjBTgQqw7rCH");
...
static const mxArray *sf_get_sim_state_info_c1_SpeedgoatCANOpen2Buses100us(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[36],T\"BrakeCtrl\",},{M[1],M[3],T\"ClearError\",},{M[1],M[71],T\"DeviceMode\",},{M[1],M[174],T\"InitStatus\",},{M[1],M[234],T\"PowerEnable\",},{M[3],M[70],T\"aux\",},{M[3],M[51],T\"aux2\",},{M[8],M[0],T\"is_active_c1_SpeedgoatCANOpen2Buses100us\",},{M[9],M[0],T\"is_c1_SpeedgoatCANOpen2Buses100us\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };
...
{
  return "sMvpgt86LXyRbdirEX6yaBC";
}
...
static void mdlSetWorkWidths_c1_SpeedgoatCANOpen2Buses100us(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(635722765U));
  ssSetChecksum1(S,(4051033041U));
  ssSetChecksum2(S,(880152590U));
  ssSetChecksum3(S,(3410486559U));
