...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_SpeedgoatCANOpen2Buses1ms_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_SpeedgoatCANOpen2Buses1ms_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_SpeedgoatCANOpen2Buses1ms_process_testpoint_info_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_SpeedgoatCANOpen2Buses1ms_process_testpoint_info_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_SpeedgoatCANOpen2Buses1ms_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "SpeedgoatCANOpen2Buses1ms") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SpeedgoatCANOpen2Buses1ms_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_SpeedgoatCANOpen2Buses1ms_third_party_uses_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "SpeedgoatCANOpen2Buses1ms") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SpeedgoatCANOpen2Buses1ms_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_SpeedgoatCANOpen2Buses1ms_jit_fallback_info( int nlhs,
  ...
  if (strcmp(machineName, "SpeedgoatCANOpen2Buses1ms") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SpeedgoatCANOpen2Buses1ms_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "SpeedgoatCANOpen2Buses1ms") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "SpeedgoatCANOpen2Buses1ms") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info(nlhs,
      plhs,3,newRhs);
  }
...
extern unsigned int sf_SpeedgoatCANOpen2Buses1ms_method_dispatcher(SimStruct *S,
  ...
  method, void *data)
{
  if (!strcmp(machineName,"SpeedgoatCANOpen2Buses1ms")) {
    return(sf_SpeedgoatCANOpen2Buses1ms_method_dispatcher(simstructPtr,
...
extern void SpeedgoatCANOpen2Buses1ms_initializer(void);
extern void SpeedgoatCANOpen2Buses1ms_register_exported_symbols(SimStruct* S);
extern void SpeedgoatCANOpen2Buses1ms_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  SpeedgoatCANOpen2Buses1ms_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      SpeedgoatCANOpen2Buses1ms_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    SpeedgoatCANOpen2Buses1ms_initializer();
    slcovUploadCoverageSynthesisById(
      "SpeedgoatCANOpen2Buses1ms@SpeedgoatCANOpen2Buses1ms");
  }
