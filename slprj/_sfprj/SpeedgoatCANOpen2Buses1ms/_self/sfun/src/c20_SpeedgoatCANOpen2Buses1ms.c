...
#define c20_IN_Active                  ((uint8_T)1U)
#define c20_IN_Active1                 ((uint8_T)2U)
#define c20_IN_Standby                 ((uint8_T)3U)
...
static void initialize_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void initialize_params_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void enable_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void disable_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void c20_update_debugger_state_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void ext_mode_exec_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void set_sim_state_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c20_st);
static void c20_set_sim_state_side_effects_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void finalize_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void sf_gateway_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void mdl_start_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void c20_chartstep_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void initSimStructsc20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static real_T c20_emlrt_marshallIn(SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct
  *chartInstance, const mxArray *c20_nargin, const char_T *c20_identifier);
...
static const mxArray *c20_b_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static boolean_T c20_c_emlrt_marshallIn
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static uint8_T c20_e_emlrt_marshallIn
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c20_b_is_active_c20_SpeedgoatCANOpen2Buses1ms, const char_T *c20_identifier);
static uint8_T c20_f_emlrt_marshallIn
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_g_emlrt_marshallIn(SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct
  *chartInstance, const mxArray *c20_b_dataWrittenToVector, const char_T
  *c20_identifier, boolean_T c20_y[2]);
static void c20_h_emlrt_marshallIn(SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, int32_T
   c20_ssid);
static void c20_init_sf_message_store_memory
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void init_dsm_address_info(SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *
  chartInstance);
  ...
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc20_SpeedgoatCANOpen2Buses1ms(chartInstance);
  ...
  *chartInstance->c20_is_active_c20_SpeedgoatCANOpen2Buses1ms = 0U;
  *chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms = c20_IN_NO_ACTIVE_CHILD;
...
static void ext_mode_exec_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  c20_update_debugger_state_c20_SpeedgoatCANOpen2Buses1ms(chartInstance);
}
  ...
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  c20_st = NULL;
  c20_y = NULL;
  sf_mex_assign(&c20_y, sf_mex_createcellmatrix(6, 1), false);
  c20_hoistedGlobal = *chartInstance->c20_e_out;
  c20_b_y = NULL;
  sf_mex_assign(&c20_b_y, sf_mex_create("y", &c20_hoistedGlobal, 0, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c20_y, 0, c20_b_y);
  c20_b_hoistedGlobal = *chartInstance->c20_timer;
  c20_c_y = NULL;
  sf_mex_assign(&c20_c_y, sf_mex_create("y", &c20_b_hoistedGlobal, 0, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c20_y, 1, c20_c_y);
  c20_c_hoistedGlobal =
    *chartInstance->c20_is_active_c20_SpeedgoatCANOpen2Buses1ms;
  c20_d_y = NULL;
  sf_mex_assign(&c20_d_y, sf_mex_create("y", &c20_c_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c20_y, 2, c20_d_y);
  c20_d_hoistedGlobal = *chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms;
  c20_e_y = NULL;
  sf_mex_assign(&c20_e_y, sf_mex_create("y", &c20_d_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c20_y, 3, c20_e_y);
  c20_e_hoistedGlobal = *chartInstance->c20_temporalCounter_i1;
  c20_f_y = NULL;
  ...
  sf_mex_assign(&c20_g_y, sf_mex_create("y",
    chartInstance->c20_dataWrittenToVector, 11, 0U, 1U, 0U, 1, 2), false);
   ...
   *c20_st)
{
  ...
  *chartInstance->c20_e_out = c20_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c20_u, 0)), "e_out");
  *chartInstance->c20_timer = c20_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c20_u, 1)), "timer");
  *chartInstance->c20_is_active_c20_SpeedgoatCANOpen2Buses1ms =
    c20_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 2)),
    "is_active_c20_SpeedgoatCANOpen2Buses1ms");
  *chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms = c20_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 3)),
     "is_c20_SpeedgoatCANOpen2Buses1ms");
  *chartInstance->c20_temporalCounter_i1 = c20_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c20_u, 4)), "temporalCounter_i1");
  ...
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  if (chartInstance->c20_doSetSimStateSideEffects != 0) {
    if ((*chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms == c20_IN_Active1)
        && (sf_mex_sub(chartInstance->c20_setSimStateSideEffectsInfo,
...
static void sf_gateway_c20_SpeedgoatCANOpen2Buses1ms
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  c20_set_sim_state_side_effects_c20_SpeedgoatCANOpen2Buses1ms(chartInstance);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  if (*chartInstance->c20_temporalCounter_i1 < 63U) {
    *chartInstance->c20_temporalCounter_i1 = (uint8_T)((uint32_T)
      *chartInstance->c20_temporalCounter_i1 + 1U);
  }

  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 18, *chartInstance->c20_sfEvent);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_Hyst, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_e_in, 0U);
  *chartInstance->c20_sfEvent = CALL_EVENT;
  c20_chartstep_c20_SpeedgoatCANOpen2Buses1ms(chartInstance);
  ...
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  uint32_T c20_c_debug_family_var_map[3];
  ...
  boolean_T c20_b_out;
  boolean_T c20_c_out;
  uint32_T c20_d_debug_family_var_map[2];
  real_T c20_d_nargin = 0.0;
  real_T c20_d_nargout = 0.0;
  uint32_T c20_e_debug_family_var_map[2];
  uint32_T c20_f_debug_family_var_map[3];
  real_T c20_e_nargin = 0.0;
  real_T c20_f_nargin = 0.0;
  real_T c20_e_nargout = 0.0;
  real_T c20_f_nargout = 1.0;
  boolean_T c20_d_out;
  uint32_T c20_g_debug_family_var_map[2];
  uint32_T c20_h_debug_family_var_map[2];
  uint32_T c20_i_debug_family_var_map[2];
  ...
  uint32_T c20_j_debug_family_var_map[2];
  real_T c20_j_nargin = 0.0;
  real_T c20_j_nargout = 0.0;
  uint32_T c20_k_debug_family_var_map[2];
  ...
  if (*chartInstance->c20_is_active_c20_SpeedgoatCANOpen2Buses1ms == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 18U,
                 *chartInstance->c20_sfEvent);
    *chartInstance->c20_is_active_c20_SpeedgoatCANOpen2Buses1ms = 1U;
    ...
    *chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms = c20_IN_Standby;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c20_sfEvent);
    _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 2U, 2U, c20_c_debug_family_names,
      c20_d_debug_family_var_map);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_nargin, 0U, c20_sf_marshallOut,
      c20_sf_marshallIn);
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_nargout, 1U, c20_sf_marshallOut,
      c20_sf_marshallIn);
    *chartInstance->c20_e_out = 0.0;
    chartInstance->c20_dataWrittenToVector[0U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c20_e_out, 2U);
    *chartInstance->c20_timer = 0.0;
    chartInstance->c20_dataWrittenToVector[1U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c20_timer, 3U);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
    switch (*chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms) {
     case c20_IN_Active:
      CV_CHART_EVAL(18, 0, c20_IN_Active);
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 2U,
                   *chartInstance->c20_sfEvent);
      _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 3U, 3U, c20_g_debug_family_names,
      ...
      if (CV_EML_COND(2, 0, 0, CV_RELATIONAL_EVAL(5U, 2U, 0,
            *chartInstance->c20_e_in, *chartInstance->c20_Hyst, -1, 2U,
            *chartInstance->c20_e_in < *chartInstance->c20_Hyst)) && CV_EML_COND
          (2, 0, 1, CV_RELATIONAL_EVAL(5U, 2U, 1, *chartInstance->c20_e_in,
            -*chartInstance->c20_Hyst, -1, 4U, *chartInstance->c20_e_in >
            -*chartInstance->c20_Hyst))) {
      ...
      if (c20_out) {
        ...
        *chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms =
          c20_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c20_sfEvent);
        *chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms = c20_IN_Active1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c20_sfEvent);
        *chartInstance->c20_temporalCounter_i1 = 0U;
        _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 2U, 2U, c20_d_debug_family_names,
          c20_h_debug_family_var_map);
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_h_nargout, 1U,
          c20_sf_marshallOut, c20_sf_marshallIn);
        *chartInstance->c20_e_out = *chartInstance->c20_e_in;
        chartInstance->c20_dataWrittenToVector[0U] = true;
        _SFD_DATA_RANGE_CHECK(*chartInstance->c20_e_out, 2U);
        *chartInstance->c20_timer = 0.0;
        chartInstance->c20_dataWrittenToVector[1U] = true;
     ...
     case c20_IN_Active1:
      CV_CHART_EVAL(18, 0, c20_IN_Active1);
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 3U,
                   *chartInstance->c20_sfEvent);
      _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 3U, 3U, c20_i_debug_family_names,
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_out, 2U, c20_b_sf_marshallOut,
        c20_b_sf_marshallIn);
      if (CV_EML_COND(3, 0, 0, *chartInstance->c20_temporalCounter_i1 >= 40) &&
          CV_EML_COND(3, 0, 1, CV_RELATIONAL_EVAL(5U, 3U, 0,
            *chartInstance->c20_e_in, *chartInstance->c20_Hyst, -1, 2U,
            *chartInstance->c20_e_in < *chartInstance->c20_Hyst)) && CV_EML_COND
          (3, 0, 2, CV_RELATIONAL_EVAL(5U, 3U, 1, *chartInstance->c20_e_in,
            -*chartInstance->c20_Hyst, -1, 4U, *chartInstance->c20_e_in >
            -*chartInstance->c20_Hyst))) {
      ...
      if (c20_b_out) {
        ...
        *chartInstance->c20_timer = 0.0;
        ...
        _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 5U,
                     *chartInstance->c20_sfEvent);
        _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 3U, 3U, c20_h_debug_family_names,
          c20_f_debug_family_var_map);
        ...
        if (CV_EML_COND(5, 0, 0, *chartInstance->c20_temporalCounter_i1 >= 40) &&
            (CV_EML_COND(5, 0, 1, CV_RELATIONAL_EVAL(5U, 5U, 0,
               *chartInstance->c20_e_in, *chartInstance->c20_Hyst, -1, 4U,
               *chartInstance->c20_e_in > *chartInstance->c20_Hyst)) ||
        ...
        if (c20_d_out) {
          ...
          *chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms =
            c20_IN_NO_ACTIVE_CHILD;
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c20_sfEvent);
          *chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms = c20_IN_Active;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c20_sfEvent);
          _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 2U, 2U, c20_debug_family_names,
            c20_k_debug_family_var_map);
     ...
     case c20_IN_Standby:
      CV_CHART_EVAL(18, 0, c20_IN_Standby);
      ...
      if (CV_EML_COND(1, 0, 0, CV_RELATIONAL_EVAL(5U, 1U, 0,
            *chartInstance->c20_e_in, *chartInstance->c20_Hyst, -1, 4U,
            *chartInstance->c20_e_in > *chartInstance->c20_Hyst)) || CV_EML_COND
          (1, 0, 1, CV_RELATIONAL_EVAL(5U, 1U, 1, *chartInstance->c20_e_in,
            -*chartInstance->c20_Hyst, -1, 2U, *chartInstance->c20_e_in <
            -*chartInstance->c20_Hyst))) {
  ...
  *c20_inData)
{
  ...
  const mxArray *c20_y = NULL;
  SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance;
  chartInstance = (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c20_nargin, const char_T *c20_identifier)
{
  ...
  c20_y = c20_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c20_nargin),
    &c20_thisId);
  sf_mex_destroy(&c20_nargin);
  return c20_y;
}
  ...
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData)
{
  ...
  chartInstance = (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *)
    chartInstanceVoid;
  c20_nargin = sf_mex_dup(c20_mxArrayInData);
...
const mxArray *sf_c20_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info
  (void)
{
   ...
   *c20_b_is_active_c20_SpeedgoatCANOpen2Buses1ms, const char_T *c20_identifier)
{
  ...
  c20_y = c20_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c20_b_is_active_c20_SpeedgoatCANOpen2Buses1ms), &c20_thisId);
  sf_mex_destroy(&c20_b_is_active_c20_SpeedgoatCANOpen2Buses1ms);
  return c20_y;
}
  ...
  boolean_T c20_y[2])
{
  ...
  int32_T c20_i2;
  (void)chartInstance;
  sf_mex_import(c20_parentId, sf_mex_dup(c20_u), c20_bv1, 1, 11, 0U, 1, 0U, 1, 2);
  for (c20_i2 = 0; c20_i2 < 2; c20_i2++) {
    c20_y[c20_i2] = c20_bv1[c20_i2];
  }
  ...
  (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  chartInstance->c20_is_active_c20_SpeedgoatCANOpen2Buses1ms = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c20_is_c20_SpeedgoatCANOpen2Buses1ms = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 2);
  chartInstance->c20_e_out = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c20_e_in = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c20_Hyst = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c20_timer = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c20_temporalCounter_i1 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 3);
}

/* SFunction Glue Code */
static uint32_T* sf_get_sfun_dwork_checksum(void);
void sf_c20_SpeedgoatCANOpen2Buses1ms_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c20_SpeedgoatCANOpen2Buses1ms_get_post_codegen_info(void);
mxArray *sf_c20_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c20_SpeedgoatCANOpen2Buses1ms_get_post_codegen_info();
...
mxArray *sf_c20_SpeedgoatCANOpen2Buses1ms_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c20_SpeedgoatCANOpen2Buses1ms_jit_fallback_info(void)
{
...
mxArray *sf_c20_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c20_SpeedgoatCANOpen2Buses1ms(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[234],T\"e_out\",},{M[1],M[304],T\"timer\",},{M[8],M[0],T\"is_active_c20_SpeedgoatCANOpen2Buses1ms\",},{M[9],M[0],T\"is_c20_SpeedgoatCANOpen2Buses1ms\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"at\",M[306],M[1]}}},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_SpeedgoatCANOpen2Buses1ms_get_check_sum(&mxChecksum);
  ...
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg
    ( (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *) chartInstance, msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance =
      (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *)sf_get_chart_instance_ptr
      (S);
...
static void chart_debug_initialize_data_addresses(SimStruct *S)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      ...
      {
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c20_e_out);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c20_e_in);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c20_Hyst);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c20_timer);
      }
    }
  }
}
...
static void sf_opaque_initialize_c20_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
  initialize_c20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c20_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  enable_c20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c20_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  disable_c20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c20_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  sf_gateway_c20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c20_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  ext_mode_exec_c20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c20_SpeedgoatCANOpen2Buses1ms
  (SimStruct* S)
{
  return get_sim_state_c20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *)sf_get_chart_instance_ptr
     (S));                             /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c20_SpeedgoatCANOpen2Buses1ms(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c20_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c20_SpeedgoatCANOpen2Buses1ms
      ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc20_SpeedgoatCANOpen2Buses1ms
    ((SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  int i;
...
mxArray *sf_c20_SpeedgoatCANOpen2Buses1ms_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c20_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
...
static void mdlRTW_c20_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance;
  chartInstance = (SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct *)utMalloc
    (sizeof(SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc20_SpeedgoatCANOpen2Buses1msInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c20_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c20_SpeedgoatCANOpen2Buses1ms;
  ...
  mdl_start_c20_SpeedgoatCANOpen2Buses1ms(chartInstance);
}

void c20_SpeedgoatCANOpen2Buses1ms_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_SpeedgoatCANOpen2Buses1ms(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_SpeedgoatCANOpen2Buses1ms(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_SpeedgoatCANOpen2Buses1ms(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_SpeedgoatCANOpen2Buses1ms_method_dispatcher.\n"
