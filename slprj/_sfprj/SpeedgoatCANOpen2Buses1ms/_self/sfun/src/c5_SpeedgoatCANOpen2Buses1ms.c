...
static void initialize_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void initialize_params_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void enable_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void disable_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void ext_mode_exec_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void set_sim_state_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c5_st);
static void c5_set_sim_state_side_effects_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void finalize_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void sf_gateway_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void mdl_start_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void initSimStructsc5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct
...
static uint8_T c5_f_emlrt_marshallIn
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c5_b_is_active_c5_SpeedgoatCANOpen2Buses1ms, const char_T *c5_identifier);
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, int32_T c5_ssid);
static void c5_init_sf_message_store_memory
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void init_dsm_address_info(SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct
  *chartInstance);
  ...
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc5_SpeedgoatCANOpen2Buses1ms(chartInstance);
  ...
  *chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses1ms = 0U;
  *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms = c5_IN_NO_ACTIVE_CHILD;
  ...
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses1ms == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 4U, *chartInstance->c5_sfEvent);
  }

  if (*chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms == c5_IN_Init) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
  }

  if (*chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms == c5_IN_Retract) {
...
static void ext_mode_exec_c5_SpeedgoatCANOpen2Buses1ms
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  c5_update_debugger_state_c5_SpeedgoatCANOpen2Buses1ms(chartInstance);
}
  ...
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  c5_b_hoistedGlobal = *chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses1ms;
  c5_c_y = NULL;
  sf_mex_assign(&c5_c_y, sf_mex_create("y", &c5_b_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c5_y, 1, c5_c_y);
  c5_c_hoistedGlobal = *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms;
  c5_d_y = NULL;
   ...
   *c5_st)
{
  ...
  *chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses1ms =
    c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
    "is_active_c5_SpeedgoatCANOpen2Buses1ms");
  ...
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  c5_set_sim_state_side_effects_c5_SpeedgoatCANOpen2Buses1ms(chartInstance);
  ...
  *chartInstance->c5_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses1ms == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 4U, *chartInstance->c5_sfEvent);
    *chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses1ms = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 4U, *chartInstance->c5_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
    *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms = c5_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
    ...
    *chartInstance->c5_Br_CurrentReq = 0.0F;
    ...
    switch (*chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms) {
     case c5_IN_Init:
      ...
      if (c5_out) {
        ...
        *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms =
          c5_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms = c5_IN_Retract;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c5_sfEvent);
        *chartInstance->c5_temporalCounter_i1 = 0U;
      } else {
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance;
  chartInstance = (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c5_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info
  (void)
{
   ...
   *c5_b_is_active_c5_SpeedgoatCANOpen2Buses1ms, const char_T *c5_identifier)
{
  ...
  c5_y = c5_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_SpeedgoatCANOpen2Buses1ms), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_SpeedgoatCANOpen2Buses1ms);
  return c5_y;
}
  ...
  (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_SpeedgoatCANOpen2Buses1ms = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c5_is_c5_SpeedgoatCANOpen2Buses1ms = (uint8_T *)
...
mxArray *sf_c5_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c5_SpeedgoatCANOpen2Buses1ms_get_post_codegen_info();
...
mxArray *sf_c5_SpeedgoatCANOpen2Buses1ms_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_SpeedgoatCANOpen2Buses1ms_jit_fallback_info(void)
{
...
mxArray *sf_c5_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_SpeedgoatCANOpen2Buses1ms(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[234],T\"Br_CurrentReq\",},{M[8],M[0],T\"is_active_c5_SpeedgoatCANOpen2Buses1ms\",},{M[9],M[0],T\"is_c5_SpeedgoatCANOpen2Buses1ms\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[79],M[1]}}},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_SpeedgoatCANOpen2Buses1ms_get_check_sum(&mxChecksum);
  ...
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg
    ( (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *) chartInstance, msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance =
      (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *)sf_get_chart_instance_ptr
      (S);
...
static void sf_opaque_initialize_c5_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
  initialize_c5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_SpeedgoatCANOpen2Buses1ms(void *chartInstanceVar)
{
  enable_c5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  disable_c5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  sf_gateway_c5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c5_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  ext_mode_exec_c5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_SpeedgoatCANOpen2Buses1ms
  (SimStruct* S)
{
  return get_sim_state_c5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_SpeedgoatCANOpen2Buses1ms(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c5_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c5_SpeedgoatCANOpen2Buses1ms
      ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_SpeedgoatCANOpen2Buses1ms
    ((SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  int i;
...
mxArray *sf_c5_SpeedgoatCANOpen2Buses1ms_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c5_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
...
static void mdlRTW_c5_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance;
  chartInstance = (SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct *)utMalloc
    (sizeof(SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc5_SpeedgoatCANOpen2Buses1msInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c5_SpeedgoatCANOpen2Buses1ms;
  ...
  mdl_start_c5_SpeedgoatCANOpen2Buses1ms(chartInstance);
}

void c5_SpeedgoatCANOpen2Buses1ms_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_SpeedgoatCANOpen2Buses1ms(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_SpeedgoatCANOpen2Buses1ms(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_SpeedgoatCANOpen2Buses1ms(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_SpeedgoatCANOpen2Buses1ms_method_dispatcher.\n"
