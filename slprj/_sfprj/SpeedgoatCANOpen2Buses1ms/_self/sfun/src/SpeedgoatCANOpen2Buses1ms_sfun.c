  ...
  method, void *data)
{
  ...
  if (chartFileNumber==24) {
    c24_SpeedgoatCANOpen2Buses1ms_method_dispatcher(simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==26) {
    c26_SpeedgoatCANOpen2Buses1ms_method_dispatcher(simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==28) {
    c28_SpeedgoatCANOpen2Buses1ms_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (!strcmp(machineName, "SpeedgoatCANOpen2Buses1ms")) {
    ...
    switch (chartFileNumber) {
     ...
     case 24:
      {
        extern mxArray *sf_c24_SpeedgoatCANOpen2Buses1ms_get_testpoint_info(void);
        plhs[0] = sf_c24_SpeedgoatCANOpen2Buses1ms_get_testpoint_info();
        break;
      }

     case 26:
      {
        extern mxArray *sf_c26_SpeedgoatCANOpen2Buses1ms_get_testpoint_info(void);
        plhs[0] = sf_c26_SpeedgoatCANOpen2Buses1ms_get_testpoint_info();
        break;
      }

     case 28:
      {
        extern mxArray *sf_c28_SpeedgoatCANOpen2Buses1ms_get_testpoint_info(void);
        plhs[0] = sf_c28_SpeedgoatCANOpen2Buses1ms_get_testpoint_info();
        break;
      }
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      switch (chartFileNumber) {
       ...
       case 24:
        {
          extern void sf_c24_SpeedgoatCANOpen2Buses1ms_get_check_sum(mxArray
            *plhs[]);
          sf_c24_SpeedgoatCANOpen2Buses1ms_get_check_sum(plhs);
          break;
        }

       case 26:
        {
          extern void sf_c26_SpeedgoatCANOpen2Buses1ms_get_check_sum(mxArray
            *plhs[]);
          sf_c26_SpeedgoatCANOpen2Buses1ms_get_check_sum(plhs);
          break;
        }

       case 28:
        {
          extern void sf_c28_SpeedgoatCANOpen2Buses1ms_get_check_sum(mxArray
            *plhs[]);
          sf_c28_SpeedgoatCANOpen2Buses1ms_get_check_sum(plhs);
          break;
        }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "pwz5hIDVSIphQ3KkRKaZaH") == 0) {
          extern mxArray
     ...
     case 24:
      {
        if (strcmp(aiChksum, "at2fmbYJL2AYbFnT5o6lkH") == 0) {
          extern mxArray
            *sf_c24_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info(void);
          plhs[0] = sf_c24_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info();
          break;
        }
     ...
     case 26:
      {
        if (strcmp(aiChksum, "3B6evMUvId1hBhDnbI4Kf") == 0) {
          extern mxArray
            *sf_c26_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info(void);
          plhs[0] = sf_c26_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info();
          break;
        }
     ...
     case 28:
      {
        if (strcmp(aiChksum, "I56xMosE7oxqDbt35fO1dE") == 0) {
          extern mxArray
            *sf_c28_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info(void);
          plhs[0] = sf_c28_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info();
          break;
        }
  ...
  nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(instanceChksum, "sElqffidgy8ZVVihBfmfiDG") == 0) {
     ...
     case 24:
      {
        if (strcmp(instanceChksum, "s3OtWbfj2vRB0xUqhDpOFLG") == 0) {
          extern const mxArray
            *sf_c24_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info
            (void);
          mxArray *persistentMxArray = (mxArray *)
            sf_c24_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info();
          plhs[0] = mxDuplicateArray(persistentMxArray);
     ...
     case 26:
      {
        if (strcmp(instanceChksum, "skxVeLo82yAR3zayK11HYPD") == 0) {
          extern const mxArray
            *sf_c26_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info
            (void);
          mxArray *persistentMxArray = (mxArray *)
            sf_c26_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info();
          plhs[0] = mxDuplicateArray(persistentMxArray);
     ...
     case 28:
      {
        if (strcmp(instanceChksum, "sOCWtmJeO3SwK36dNfBYCvC") == 0) {
          extern const mxArray
            *sf_c28_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info
            (void);
          mxArray *persistentMxArray = (mxArray *)
            sf_c28_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info();
          plhs[0] = mxDuplicateArray(persistentMxArray);
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "sElqffidgy8ZVVihBfmfiDG") == 0) {
     ...
     case 24:
      {
        if (strcmp(tpChksum, "s3OtWbfj2vRB0xUqhDpOFLG") == 0) {
          extern mxArray *sf_c24_SpeedgoatCANOpen2Buses1ms_third_party_uses_info
            (void);
          plhs[0] = sf_c24_SpeedgoatCANOpen2Buses1ms_third_party_uses_info();
          break;
        }
      }
     ...
     case 26:
      {
        if (strcmp(tpChksum, "skxVeLo82yAR3zayK11HYPD") == 0) {
          extern mxArray *sf_c26_SpeedgoatCANOpen2Buses1ms_third_party_uses_info
            (void);
          plhs[0] = sf_c26_SpeedgoatCANOpen2Buses1ms_third_party_uses_info();
          break;
        }
      }
     ...
     case 28:
      {
        if (strcmp(tpChksum, "sOCWtmJeO3SwK36dNfBYCvC") == 0) {
          extern mxArray *sf_c28_SpeedgoatCANOpen2Buses1ms_third_party_uses_info
            (void);
          plhs[0] = sf_c28_SpeedgoatCANOpen2Buses1ms_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 24:
      {
        if (strcmp(tpChksum, "s3OtWbfj2vRB0xUqhDpOFLG") == 0) {
          extern mxArray *sf_c24_SpeedgoatCANOpen2Buses1ms_jit_fallback_info
            (void);
          plhs[0] = sf_c24_SpeedgoatCANOpen2Buses1ms_jit_fallback_info();
          break;
        }
      }
     ...
     case 26:
      {
        if (strcmp(tpChksum, "skxVeLo82yAR3zayK11HYPD") == 0) {
          extern mxArray *sf_c26_SpeedgoatCANOpen2Buses1ms_jit_fallback_info
            (void);
          plhs[0] = sf_c26_SpeedgoatCANOpen2Buses1ms_jit_fallback_info();
          break;
        }
      }
     ...
     case 28:
      {
        if (strcmp(tpChksum, "sOCWtmJeO3SwK36dNfBYCvC") == 0) {
          extern mxArray *sf_c28_SpeedgoatCANOpen2Buses1ms_jit_fallback_info
            (void);
          plhs[0] = sf_c28_SpeedgoatCANOpen2Buses1ms_jit_fallback_info();
          break;
        }
      }
     ...
     case 24:
      {
        if (strcmp(tpChksum, "s3OtWbfj2vRB0xUqhDpOFLG") == 0) {
          extern mxArray
            *sf_c24_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info(void);
          plhs[0] = sf_c24_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info();
          break;
        }
      }
     ...
     case 26:
      {
        if (strcmp(tpChksum, "skxVeLo82yAR3zayK11HYPD") == 0) {
          extern mxArray
            *sf_c26_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info(void);
          plhs[0] = sf_c26_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info();
          break;
        }
      }
     ...
     case 28:
      {
        if (strcmp(tpChksum, "sOCWtmJeO3SwK36dNfBYCvC") == 0) {
          extern mxArray
            *sf_c28_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info(void);
          plhs[0] = sf_c28_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info();
          break;
        }
      }
  ...
  debugInstance)
{
  _SpeedgoatCANOpen2Buses1msMachineNumber_ = sf_debug_initialize_machine
    (debugInstance,"SpeedgoatCANOpen2Buses1ms","sfun",0,17,0,0,0);
