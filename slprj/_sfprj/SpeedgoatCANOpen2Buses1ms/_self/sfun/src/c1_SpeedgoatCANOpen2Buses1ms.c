      ...
      if (c1_b_out) {
        ...
        *chartInstance->c1_is_c1_SpeedgoatCANOpen2Buses1ms = c1_IN_Init;
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_d_nargout, 1U,
          c1_sf_marshallOut, c1_sf_marshallIn);
        *chartInstance->c1_DeviceMode = 3.0F;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1700140564U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(230515456U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2730247307U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1773171458U);
}
...
mxArray *sf_c1_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("TAAHtTzZ1K3cn5UpZkn1W");
...
{
  return "skT9LIwaR5b5k2uHPrlqXdC";
}
...
static void mdlSetWorkWidths_c1_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2036364743U));
  ssSetChecksum1(S,(682807972U));
  ssSetChecksum2(S,(1409967083U));
  ssSetChecksum3(S,(3975376020U));
