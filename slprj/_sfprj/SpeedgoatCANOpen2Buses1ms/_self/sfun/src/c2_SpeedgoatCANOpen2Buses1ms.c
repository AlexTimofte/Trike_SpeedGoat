...
static void initialize_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void initialize_params_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void enable_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void disable_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void ext_mode_exec_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void set_sim_state_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void c2_set_sim_state_side_effects_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void finalize_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void sf_gateway_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void mdl_start_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void c2_chartstep_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void initSimStructsc2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void c2_enter_atomic_Init(SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct
  *chartInstance);
static void c2_enter_atomic_Wait(SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct
...
static uint8_T c2_f_emlrt_marshallIn
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_SpeedgoatCANOpen2Buses1ms, const char_T *c2_identifier);
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_h_emlrt_marshallIn(SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct
  *chartInstance, const mxArray *c2_b_dataWrittenToVector, const char_T
  *c2_identifier, boolean_T c2_y[7]);
static void c2_i_emlrt_marshallIn(SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  boolean_T c2_y[7]);
...
static const mxArray *sf_get_hover_data_for_msg
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance, int32_T c2_ssid);
static void c2_init_sf_message_store_memory
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance);
static void init_dsm_address_info(SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct
  *chartInstance);
  ...
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_SpeedgoatCANOpen2Buses1ms(chartInstance);
  ...
  *chartInstance->c2_is_active_c2_SpeedgoatCANOpen2Buses1ms = 0U;
  *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = c2_IN_NO_ACTIVE_CHILD;
...
static void ext_mode_exec_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  c2_update_debugger_state_c2_SpeedgoatCANOpen2Buses1ms(chartInstance);
}
  ...
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  c2_h_hoistedGlobal = *chartInstance->c2_is_active_c2_SpeedgoatCANOpen2Buses1ms;
  c2_i_y = NULL;
  sf_mex_assign(&c2_i_y, sf_mex_create("y", &c2_h_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c2_y, 7, c2_i_y);
  c2_i_hoistedGlobal = *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms;
  c2_j_y = NULL;
   ...
   *c2_st)
{
  ...
  *chartInstance->c2_is_active_c2_SpeedgoatCANOpen2Buses1ms =
    c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 7)),
    "is_active_c2_SpeedgoatCANOpen2Buses1ms");
  *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 8)),
     "is_c2_SpeedgoatCANOpen2Buses1ms");
...
static void sf_gateway_c2_SpeedgoatCANOpen2Buses1ms
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  c2_set_sim_state_side_effects_c2_SpeedgoatCANOpen2Buses1ms(chartInstance);
  ...
  *chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_SpeedgoatCANOpen2Buses1ms(chartInstance);
  ...
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  boolean_T c2_c_out;
  uint32_T c2_d_debug_family_var_map[2];
  ...
  boolean_T c2_d_out;
  uint32_T c2_h_debug_family_var_map[3];
  ...
  if (*chartInstance->c2_is_active_c2_SpeedgoatCANOpen2Buses1ms == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 1U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_active_c2_SpeedgoatCANOpen2Buses1ms = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, *chartInstance->c2_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, *chartInstance->c2_sfEvent);
    *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = c2_IN_Init;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c2_sfEvent);
    c2_enter_atomic_Init(chartInstance);
  } else {
    switch (*chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms) {
     case c2_IN_Clear_Error:
      ...
      if (CV_EML_IF(2, 0, 0, CV_RELATIONAL_EVAL(5U, 2U, 0, (real_T)
            *chartInstance->c2_aux, 4000.0, -1, 4U, *chartInstance->c2_aux >
            4000.0F))) {
        c2_out = true;
      } else {
        c2_out = false;
      ...
      if (c2_out) {
        ...
        *chartInstance->c2_aux = 0.0F;
        ...
        _SFD_SYMBOL_SCOPE_POP();
        *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms =
          c2_IN_NO_ACTIVE_CHILD;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c2_sfEvent);
        *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = c2_IN_Wait;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 3U, *chartInstance->c2_sfEvent);
        c2_enter_atomic_Wait(chartInstance);
      } else {
      ...
      *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = c2_IN_NO_ACTIVE_CHILD;
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c2_sfEvent);
      *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = c2_IN_Clear_Error;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c2_sfEvent);
      ...
      if (c2_b_out) {
        ...
        *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = c2_IN_Init;
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_d_nargout, 1U,
          c2_sf_marshallOut, c2_sf_marshallIn);
        *chartInstance->c2_DeviceMode = 3.0F;
      ...
      *chartInstance->c2_BrakeCtrl = 2.0F;
      ...
      if (CV_EML_COND(3, 0, 0, CV_RELATIONAL_EVAL(5U, 3U, 0, (real_T)
            *chartInstance->c2_aux, 20.0, -1, 2U, *chartInstance->c2_aux < 20.0F))
          && CV_EML_COND(3, 0, 1, CV_RELATIONAL_EVAL(5U, 3U, 1, (real_T)
            *chartInstance->c2_ReadError, 1.0, -1, 0U,
            *chartInstance->c2_ReadError == 1.0F))) {
      ...
      if (c2_c_out) {
        ...
        *chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = c2_IN_Wait;
        ...
        if (CV_EML_COND(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0, (real_T)
              *chartInstance->c2_aux, 20.0, -1, 5U, *chartInstance->c2_aux >=
              20.0F)) && CV_EML_COND(4, 0, 1, CV_RELATIONAL_EVAL(5U, 4U, 1,
              (real_T)*chartInstance->c2_ReadError, 1.0, -1, 0U,
              *chartInstance->c2_ReadError == 1.0F))) {
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance;
  chartInstance = (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_SpeedgoatCANOpen2Buses1ms_get_eml_resolved_functions_info
  (void)
{
   ...
   *c2_b_is_active_c2_SpeedgoatCANOpen2Buses1ms, const char_T *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_SpeedgoatCANOpen2Buses1ms), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_SpeedgoatCANOpen2Buses1ms);
  return c2_y;
}
  ...
  (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_SpeedgoatCANOpen2Buses1ms = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c2_is_c2_SpeedgoatCANOpen2Buses1ms = (uint8_T *)
...
void sf_c2_SpeedgoatCANOpen2Buses1ms_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4218628007U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1430675501U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(170640608U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3944467518U);
}

mxArray* sf_c2_SpeedgoatCANOpen2Buses1ms_get_post_codegen_info(void);
mxArray *sf_c2_SpeedgoatCANOpen2Buses1ms_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("bLEfVj1vK2aw3nRUQFoyqB");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_SpeedgoatCANOpen2Buses1ms_get_post_codegen_info();
...
mxArray *sf_c2_SpeedgoatCANOpen2Buses1ms_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_SpeedgoatCANOpen2Buses1ms_jit_fallback_info(void)
{
...
mxArray *sf_c2_SpeedgoatCANOpen2Buses1ms_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_SpeedgoatCANOpen2Buses1ms(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[36],T\"BrakeCtrl\",},{M[1],M[3],T\"ClearError\",},{M[1],M[71],T\"DeviceMode\",},{M[1],M[174],T\"InitStatus\",},{M[1],M[234],T\"PowerEnable\",},{M[3],M[70],T\"aux\",},{M[3],M[51],T\"aux2\",},{M[8],M[0],T\"is_active_c2_SpeedgoatCANOpen2Buses1ms\",},{M[9],M[0],T\"is_c2_SpeedgoatCANOpen2Buses1ms\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 10, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_SpeedgoatCANOpen2Buses1ms_get_check_sum(&mxChecksum);
  ...
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg
    ( (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *) chartInstance, msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance =
      (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *)sf_get_chart_instance_ptr
      (S);
...
{
  return "sOzzLQgBaNlv7JsJzuoWAIB";
}
...
static void sf_opaque_initialize_c2_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
  initialize_c2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_SpeedgoatCANOpen2Buses1ms(void *chartInstanceVar)
{
  enable_c2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  disable_c2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  sf_gateway_c2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c2_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  ext_mode_exec_c2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_SpeedgoatCANOpen2Buses1ms
  (SimStruct* S)
{
  return get_sim_state_c2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_SpeedgoatCANOpen2Buses1ms(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c2_SpeedgoatCANOpen2Buses1ms(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    finalize_c2_SpeedgoatCANOpen2Buses1ms
      ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_SpeedgoatCANOpen2Buses1ms
    ((SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  int i;
...
mxArray *sf_c2_SpeedgoatCANOpen2Buses1ms_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c2_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1654728377U));
  ssSetChecksum1(S,(883868065U));
  ssSetChecksum2(S,(416760121U));
  ssSetChecksum3(S,(236465431U));
...
static void mdlRTW_c2_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_SpeedgoatCANOpen2Buses1ms(SimStruct *S)
{
  SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *chartInstance;
  chartInstance = (SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct *)utMalloc
    (sizeof(SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_SpeedgoatCANOpen2Buses1msInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_SpeedgoatCANOpen2Buses1ms;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c2_SpeedgoatCANOpen2Buses1ms;
  ...
  mdl_start_c2_SpeedgoatCANOpen2Buses1ms(chartInstance);
}

void c2_SpeedgoatCANOpen2Buses1ms_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_SpeedgoatCANOpen2Buses1ms(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_SpeedgoatCANOpen2Buses1ms(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_SpeedgoatCANOpen2Buses1ms(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_SpeedgoatCANOpen2Buses1ms_method_dispatcher.\n"
