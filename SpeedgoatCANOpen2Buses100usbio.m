...
bio(107).sigName='PosRef [m]';
bio(107).portIdx=0;
bio(107).dim=[1,1];
bio(107).sigWidth=1;
bio(107).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PosRefm';
bio(107).ndims=2;
bio(107).size=[];
...
bio(108).dim=[1,1];
bio(108).sigWidth=1;
bio(108).sigAddress='&SpeedgoatCANOpen2Buses100us_B.n';
bio(108).ndims=2;
bio(108).size=[];
...
bio(109).dim=[1,1];
bio(109).sigWidth=1;
bio(109).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Product2_a';
bio(109).ndims=2;
bio(109).size=[];
bio(109).isStruct=false;

bio(110).blkName='Trike Application Layer/System_Control/TractionControl/Abs';
bio(110).sigName='TractionRef';
bio(110).portIdx=0;
bio(110).dim=[1,1];
bio(110).sigWidth=1;
bio(110).sigAddress='&SpeedgoatCANOpen2Buses100us_B.TractionRef';
bio(110).ndims=2;
bio(110).size=[];
...
bio(112).sigName='SpeedRear_SI';
bio(112).portIdx=0;
bio(112).dim=[1,1];
bio(112).sigWidth=1;
bio(112).sigAddress='&SpeedgoatCANOpen2Buses100us_B.SpeedRear_SI';
bio(112).ndims=2;
bio(112).size=[];
bio(112).isStruct=false;

bio(113).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/DunkD_Brake_Init_CurrentMode/p1';
bio(113).sigName='';
bio(113).portIdx=0;
bio(113).dim=[1,1];
bio(113).sigWidth=1;
bio(113).sigAddress='&SpeedgoatCANOpen2Buses100us_B.ClearError_k';
bio(113).ndims=2;
bio(113).size=[];
bio(113).isStruct=false;

bio(114).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/DunkD_Brake_Init_CurrentMode/p2';
bio(114).sigName='';
bio(114).portIdx=1;
bio(114).dim=[1,1];
bio(114).sigWidth=1;
bio(114).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DeviceMode_b';
bio(114).ndims=2;
bio(114).size=[];
bio(114).isStruct=false;

bio(115).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/DunkD_Brake_Init_CurrentMode/p3';
bio(115).sigName='';
bio(115).portIdx=2;
bio(115).dim=[1,1];
bio(115).sigWidth=1;
bio(115).sigAddress='&SpeedgoatCANOpen2Buses100us_B.BrakeCtrl_n';
bio(115).ndims=2;
bio(115).size=[];
bio(115).isStruct=false;

bio(116).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/DunkD_Brake_Init_CurrentMode/p4';
bio(116).sigName='';
bio(116).portIdx=3;
bio(116).dim=[1,1];
bio(116).sigWidth=1;
bio(116).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PowerEnable_au';
bio(116).ndims=2;
bio(116).size=[];
bio(116).isStruct=false;

bio(117).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/DunkD_Brake_Init_CurrentMode/p5';
bio(117).sigName='';
bio(117).portIdx=4;
bio(117).dim=[1,1];
bio(117).sigWidth=1;
bio(117).sigAddress='&SpeedgoatCANOpen2Buses100us_B.InitStatus_h';
bio(117).ndims=2;
bio(117).size=[];
bio(117).isStruct=false;

bio(118).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/Constant';
bio(118).sigName='';
bio(118).portIdx=0;
bio(118).dim=[1,1];
bio(118).sigWidth=1;
bio(118).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Constant_g';
bio(118).ndims=2;
bio(118).size=[];
bio(118).isStruct=false;

bio(119).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/Cast To Single';
bio(119).sigName='DeviceMode';
bio(119).portIdx=0;
bio(119).dim=[1,1];
bio(119).sigWidth=1;
bio(119).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DeviceMode_g';
bio(119).ndims=2;
bio(119).size=[];
bio(119).isStruct=false;

bio(120).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/Cast To Single1';
bio(120).sigName='ClearError';
bio(120).portIdx=0;
bio(120).dim=[1,1];
bio(120).sigWidth=1;
bio(120).sigAddress='&SpeedgoatCANOpen2Buses100us_B.ClearError_mj';
bio(120).ndims=2;
bio(120).size=[];
bio(120).isStruct=false;

bio(121).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/Cast To Single2';
bio(121).sigName='BrakeCtrl';
bio(121).portIdx=0;
bio(121).dim=[1,1];
bio(121).sigWidth=1;
bio(121).sigAddress='&SpeedgoatCANOpen2Buses100us_B.BrakeCtrl_k2';
bio(121).ndims=2;
bio(121).size=[];
bio(121).isStruct=false;

bio(122).blkName='Trike Application Layer/System_Init/Brakes_DunkMotor_Init/Cast To Single3';
bio(122).sigName='PowerEnable';
bio(122).portIdx=0;
bio(122).dim=[1,1];
bio(122).sigWidth=1;
bio(122).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PowerEnable_p';
bio(122).ndims=2;
bio(122).size=[];
bio(122).isStruct=false;

bio(123).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/DunkA_Steering_Init_SpeedMode/p1';
bio(123).sigName='';
bio(123).portIdx=0;
bio(123).dim=[1,1];
bio(123).sigWidth=1;
bio(123).sigAddress='&SpeedgoatCANOpen2Buses100us_B.ClearError_n';
bio(123).ndims=2;
bio(123).size=[];
bio(123).isStruct=false;

bio(124).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/DunkA_Steering_Init_SpeedMode/p2';
bio(124).sigName='';
bio(124).portIdx=1;
bio(124).dim=[1,1];
bio(124).sigWidth=1;
bio(124).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DeviceMode_o';
bio(124).ndims=2;
bio(124).size=[];
bio(124).isStruct=false;

bio(125).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/DunkA_Steering_Init_SpeedMode/p3';
bio(125).sigName='';
bio(125).portIdx=2;
bio(125).dim=[1,1];
bio(125).sigWidth=1;
bio(125).sigAddress='&SpeedgoatCANOpen2Buses100us_B.BrakeCtrl_b';
bio(125).ndims=2;
bio(125).size=[];
bio(125).isStruct=false;

bio(126).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/DunkA_Steering_Init_SpeedMode/p4';
bio(126).sigName='';
bio(126).portIdx=3;
bio(126).dim=[1,1];
bio(126).sigWidth=1;
bio(126).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PowerEnable_a';
bio(126).ndims=2;
bio(126).size=[];
bio(126).isStruct=false;

bio(127).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/DunkA_Steering_Init_SpeedMode/p5';
bio(127).sigName='';
bio(127).portIdx=4;
bio(127).dim=[1,1];
bio(127).sigWidth=1;
bio(127).sigAddress='&SpeedgoatCANOpen2Buses100us_B.InitStatus_f';
bio(127).ndims=2;
bio(127).size=[];
bio(127).isStruct=false;

bio(128).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/Constant';
bio(128).sigName='';
bio(128).portIdx=0;
bio(128).dim=[1,1];
bio(128).sigWidth=1;
bio(128).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Constant';
bio(128).ndims=2;
bio(128).size=[];
bio(128).isStruct=false;

bio(129).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/Cast To Single';
bio(129).sigName='DeviceMode';
bio(129).portIdx=0;
bio(129).dim=[1,1];
bio(129).sigWidth=1;
bio(129).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DeviceMode_e';
bio(129).ndims=2;
bio(129).size=[];
bio(129).isStruct=false;

bio(130).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/Cast To Single1';
bio(130).sigName='ClearError';
bio(130).portIdx=0;
bio(130).dim=[1,1];
bio(130).sigWidth=1;
bio(130).sigAddress='&SpeedgoatCANOpen2Buses100us_B.ClearError_m';
bio(130).ndims=2;
bio(130).size=[];
bio(130).isStruct=false;

bio(131).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/Cast To Single2';
bio(131).sigName='BrakeCtrl';
bio(131).portIdx=0;
bio(131).dim=[1,1];
bio(131).sigWidth=1;
bio(131).sigAddress='&SpeedgoatCANOpen2Buses100us_B.BrakeCtrl_mu';
bio(131).ndims=2;
bio(131).size=[];
bio(131).isStruct=false;

bio(132).blkName='Trike Application Layer/System_Init/Steering_DunkMotor_Init/Cast To Single3';
bio(132).sigName='PowerEnable';
bio(132).portIdx=0;
bio(132).dim=[1,1];
bio(132).sigWidth=1;
bio(132).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PowerEnable_i';
bio(132).ndims=2;
bio(132).size=[];
bio(132).isStruct=false;

bio(133).blkName='Trike Application Layer/System_Init/Subsystem/Sum';
bio(133).sigName='';
bio(133).portIdx=0;
bio(133).dim=[1,1];
bio(133).sigWidth=1;
bio(133).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Sum_b';
bio(133).ndims=2;
bio(133).size=[];
bio(133).isStruct=false;

bio(134).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/DunkC_TiltLeft_Init_CurrentMode/p1';
bio(134).sigName='';
bio(134).portIdx=0;
bio(134).dim=[1,1];
bio(134).sigWidth=1;
bio(134).sigAddress='&SpeedgoatCANOpen2Buses100us_B.ClearError_h';
bio(134).ndims=2;
bio(134).size=[];
bio(134).isStruct=false;

bio(135).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/DunkC_TiltLeft_Init_CurrentMode/p2';
bio(135).sigName='';
bio(135).portIdx=1;
bio(135).dim=[1,1];
bio(135).sigWidth=1;
bio(135).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DeviceMode_f';
bio(135).ndims=2;
bio(135).size=[];
bio(135).isStruct=false;

bio(136).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/DunkC_TiltLeft_Init_CurrentMode/p3';
bio(136).sigName='';
bio(136).portIdx=2;
bio(136).dim=[1,1];
bio(136).sigWidth=1;
bio(136).sigAddress='&SpeedgoatCANOpen2Buses100us_B.BrakeCtrl_m';
bio(136).ndims=2;
bio(136).size=[];
bio(136).isStruct=false;

bio(137).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/DunkC_TiltLeft_Init_CurrentMode/p4';
bio(137).sigName='';
bio(137).portIdx=3;
bio(137).dim=[1,1];
bio(137).sigWidth=1;
bio(137).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PowerEnable_m';
bio(137).ndims=2;
bio(137).size=[];
bio(137).isStruct=false;

bio(138).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/DunkC_TiltLeft_Init_CurrentMode/p5';
bio(138).sigName='';
bio(138).portIdx=4;
bio(138).dim=[1,1];
bio(138).sigWidth=1;
bio(138).sigAddress='&SpeedgoatCANOpen2Buses100us_B.InitStatus_k';
bio(138).ndims=2;
bio(138).size=[];
bio(138).isStruct=false;

bio(139).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/Constant';
bio(139).sigName='';
bio(139).portIdx=0;
bio(139).dim=[1,1];
bio(139).sigWidth=1;
bio(139).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Constant_m';
bio(139).ndims=2;
bio(139).size=[];
bio(139).isStruct=false;

bio(140).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/Cast To Single';
bio(140).sigName='DeviceMode';
bio(140).portIdx=0;
bio(140).dim=[1,1];
bio(140).sigWidth=1;
bio(140).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DeviceMode_h';
bio(140).ndims=2;
bio(140).size=[];
bio(140).isStruct=false;

bio(141).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/Cast To Single1';
bio(141).sigName='ClearError';
bio(141).portIdx=0;
bio(141).dim=[1,1];
bio(141).sigWidth=1;
bio(141).sigAddress='&SpeedgoatCANOpen2Buses100us_B.ClearError_jb';
bio(141).ndims=2;
bio(141).size=[];
bio(141).isStruct=false;

bio(142).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/Cast To Single2';
bio(142).sigName='BrakeCtrl';
bio(142).portIdx=0;
bio(142).dim=[1,1];
bio(142).sigWidth=1;
bio(142).sigAddress='&SpeedgoatCANOpen2Buses100us_B.BrakeCtrl_bj';
bio(142).ndims=2;
bio(142).size=[];
bio(142).isStruct=false;

bio(143).blkName='Trike Application Layer/System_Init/TiltingLeft_DunkMotor_Init/Cast To Single3';
bio(143).sigName='PowerEnable';
bio(143).portIdx=0;
bio(143).dim=[1,1];
bio(143).sigWidth=1;
bio(143).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PowerEnable_ar';
bio(143).ndims=2;
bio(143).size=[];
bio(143).isStruct=false;

bio(144).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/DunkB_TiltRight_Init_CurrentMode/p1';
bio(144).sigName='';
bio(144).portIdx=0;
bio(144).dim=[1,1];
bio(144).sigWidth=1;
bio(144).sigAddress='&SpeedgoatCANOpen2Buses100us_B.ClearError';
bio(144).ndims=2;
bio(144).size=[];
bio(144).isStruct=false;

bio(145).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/DunkB_TiltRight_Init_CurrentMode/p2';
bio(145).sigName='';
bio(145).portIdx=1;
bio(145).dim=[1,1];
bio(145).sigWidth=1;
bio(145).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DeviceMode';
bio(145).ndims=2;
bio(145).size=[];
bio(145).isStruct=false;

bio(146).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/DunkB_TiltRight_Init_CurrentMode/p3';
bio(146).sigName='';
bio(146).portIdx=2;
bio(146).dim=[1,1];
bio(146).sigWidth=1;
bio(146).sigAddress='&SpeedgoatCANOpen2Buses100us_B.BrakeCtrl';
bio(146).ndims=2;
bio(146).size=[];
bio(146).isStruct=false;

bio(147).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/DunkB_TiltRight_Init_CurrentMode/p4';
bio(147).sigName='';
bio(147).portIdx=3;
bio(147).dim=[1,1];
bio(147).sigWidth=1;
bio(147).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PowerEnable';
bio(147).ndims=2;
bio(147).size=[];
bio(147).isStruct=false;

bio(148).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/DunkB_TiltRight_Init_CurrentMode/p5';
bio(148).sigName='';
bio(148).portIdx=4;
bio(148).dim=[1,1];
bio(148).sigWidth=1;
bio(148).sigAddress='&SpeedgoatCANOpen2Buses100us_B.InitStatus';
bio(148).ndims=2;
bio(148).size=[];
bio(148).isStruct=false;

bio(149).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/Constant';
bio(149).sigName='';
bio(149).portIdx=0;
bio(149).dim=[1,1];
bio(149).sigWidth=1;
bio(149).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Constant_e';
bio(149).ndims=2;
bio(149).size=[];
bio(149).isStruct=false;

bio(150).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/Cast To Single';
bio(150).sigName='DeviceMode';
bio(150).portIdx=0;
bio(150).dim=[1,1];
bio(150).sigWidth=1;
bio(150).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DeviceMode_d';
bio(150).ndims=2;
bio(150).size=[];
bio(150).isStruct=false;

bio(151).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/Cast To Single1';
bio(151).sigName='ClearError';
bio(151).portIdx=0;
bio(151).dim=[1,1];
bio(151).sigWidth=1;
bio(151).sigAddress='&SpeedgoatCANOpen2Buses100us_B.ClearError_j';
bio(151).ndims=2;
bio(151).size=[];
bio(151).isStruct=false;

bio(152).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/Cast To Single2';
bio(152).sigName='BrakeCtrl';
bio(152).portIdx=0;
bio(152).dim=[1,1];
bio(152).sigWidth=1;
bio(152).sigAddress='&SpeedgoatCANOpen2Buses100us_B.BrakeCtrl_k';
bio(152).ndims=2;
bio(152).size=[];
bio(152).isStruct=false;

bio(153).blkName='Trike Application Layer/System_Init/TiltingRight_DunkMotor_Init/Cast To Single3';
bio(153).sigName='PowerEnable';
bio(153).portIdx=0;
bio(153).dim=[1,1];
bio(153).sigWidth=1;
bio(153).sigAddress='&SpeedgoatCANOpen2Buses100us_B.PowerEnable_ir';
bio(153).ndims=2;
bio(153).size=[];
bio(153).isStruct=false;

bio(154).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #1 (A)/CAN RX Wrapper/CAN Read/p1';
bio(154).sigName='';
bio(154).portIdx=0;
bio(154).dim=[1,1];
bio(154).sigWidth=1;
bio(154).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o1';
bio(154).ndims=2;
bio(154).size=[];
bio(154).isStruct=false;

bio(155).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #1 (A)/CAN RX Wrapper/CAN Read/p2';
bio(155).sigName='';
bio(155).portIdx=1;
bio(155).dim=[1,1];
bio(155).sigWidth=1;
bio(155).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o2';
bio(155).ndims=2;
bio(155).size=[];
bio(155).isStruct=false;

bio(156).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #1 (A)/CAN RX Wrapper/CAN Read/p3';
bio(156).sigName='';
bio(156).portIdx=2;
bio(156).dim=[1,1];
bio(156).sigWidth=1;
bio(156).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o3';
bio(156).ndims=2;
bio(156).size=[];
bio(156).isStruct=false;

bio(157).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #1 (A)/CAN RX Wrapper/CAN Read/p4';
bio(157).sigName='';
bio(157).portIdx=3;
bio(157).dim=[1,1];
bio(157).sigWidth=1;
bio(157).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o4';
bio(157).ndims=2;
bio(157).size=[];
bio(157).isStruct=false;

bio(158).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #1 (A)/CAN RX Wrapper/CAN Read/p5';
bio(158).sigName='';
bio(158).portIdx=4;
bio(158).dim=[1,1];
bio(158).sigWidth=1;
bio(158).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o5';
bio(158).ndims=2;
bio(158).size=[];
bio(158).isStruct=false;

bio(159).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #1 (A)/CAN RX Wrapper/CAN Read/p6';
bio(159).sigName='';
bio(159).portIdx=5;
bio(159).dim=[8,1];
bio(159).sigWidth=8;
bio(159).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o6[0]';
bio(159).ndims=2;
bio(159).size=[];
bio(159).isStruct=false;

bio(160).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #1 (A)/CAN RX Wrapper/Switch';
bio(160).sigName='';
bio(160).portIdx=0;
bio(160).dim=[1,1];
bio(160).sigWidth=1;
bio(160).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Switch_c';
bio(160).ndims=2;
bio(160).size=[];
bio(160).isStruct=false;

bio(161).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #1 (A)/CAN TX Wrapper/Constant';
bio(161).sigName='';
bio(161).portIdx=0;
bio(161).dim=[1,1];
bio(161).sigWidth=1;
bio(161).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Constant_ge';
bio(161).ndims=2;
bio(161).size=[];
bio(161).isStruct=false;

bio(162).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #2 (B)/CAN RX Wrapper/CAN Read/p1';
bio(162).sigName='';
bio(162).portIdx=0;
bio(162).dim=[1,1];
bio(162).sigWidth=1;
bio(162).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o1_b';
bio(162).ndims=2;
bio(162).size=[];
bio(162).isStruct=false;

bio(163).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #2 (B)/CAN RX Wrapper/CAN Read/p2';
bio(163).sigName='';
bio(163).portIdx=1;
bio(163).dim=[1,1];
bio(163).sigWidth=1;
bio(163).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o2_e';
bio(163).ndims=2;
bio(163).size=[];
bio(163).isStruct=false;

bio(164).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #2 (B)/CAN RX Wrapper/CAN Read/p3';
bio(164).sigName='';
bio(164).portIdx=2;
bio(164).dim=[1,1];
bio(164).sigWidth=1;
bio(164).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o3_m';
bio(164).ndims=2;
bio(164).size=[];
bio(164).isStruct=false;

bio(165).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #2 (B)/CAN RX Wrapper/CAN Read/p4';
bio(165).sigName='';
bio(165).portIdx=3;
bio(165).dim=[1,1];
bio(165).sigWidth=1;
bio(165).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o4_a';
bio(165).ndims=2;
bio(165).size=[];
bio(165).isStruct=false;

bio(166).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #2 (B)/CAN RX Wrapper/CAN Read/p5';
bio(166).sigName='';
bio(166).portIdx=4;
bio(166).dim=[1,1];
bio(166).sigWidth=1;
bio(166).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o5_h';
bio(166).ndims=2;
bio(166).size=[];
bio(166).isStruct=false;

bio(167).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #2 (B)/CAN RX Wrapper/CAN Read/p6';
bio(167).sigName='';
bio(167).portIdx=5;
bio(167).dim=[8,1];
bio(167).sigWidth=8;
bio(167).sigAddress='&SpeedgoatCANOpen2Buses100us_B.CANRead_o6_h[0]';
bio(167).ndims=2;
bio(167).size=[];
bio(167).isStruct=false;

bio(168).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #2 (B)/CAN RX Wrapper/Switch';
bio(168).sigName='';
bio(168).portIdx=0;
bio(168).dim=[1,1];
bio(168).sigWidth=1;
bio(168).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Switch_g';
bio(168).ndims=2;
bio(168).size=[];
bio(168).isStruct=false;

bio(169).blkName='Speedgoat_TPDOs/CAN Bus Communication/CANOpen Slave  Protocol Stack - CAN Bus #2 (B)/CAN TX Wrapper/Constant';
bio(169).sigName='';
bio(169).portIdx=0;
bio(169).dim=[1,1];
bio(169).sigWidth=1;
bio(169).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Constant_em';
bio(169).ndims=2;
bio(169).size=[];
bio(169).isStruct=false;

bio(170).blkName='Trike Application Layer/System_Control/TiltingControl/Offset_Conversion/LSB2Volt';
bio(170).sigName='DispLeft [Volt]';
bio(170).portIdx=0;
bio(170).dim=[1,1];
bio(170).sigWidth=1;
bio(170).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DispLeftVolt';
bio(170).ndims=2;
bio(170).size=[];
bio(170).isStruct=false;

bio(171).blkName='Trike Application Layer/System_Control/TiltingControl/Offset_Conversion/Volt2meter';
bio(171).sigName='DispLeft [m]';
bio(171).portIdx=0;
bio(171).dim=[1,1];
bio(171).sigWidth=1;
bio(171).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DispLeftm';
bio(171).ndims=2;
bio(171).size=[];
bio(171).isStruct=false;

bio(172).blkName='Trike Application Layer/System_Control/TiltingControl/Offset_Conversion/Memory1';
bio(172).sigName='DispLeft [m] filt';
bio(172).portIdx=0;
bio(172).dim=[1,1];
bio(172).sigWidth=1;
bio(172).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DispLeftmfilt_k';
bio(172).ndims=2;
bio(172).size=[];
bio(172).isStruct=false;

bio(173).blkName='Trike Application Layer/System_Control/TiltingControl/Offset_Conversion/Sum';
bio(173).sigName='DispLeftOffset [Volt]';
bio(173).portIdx=0;
bio(173).dim=[1,1];
bio(173).sigWidth=1;
bio(173).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DispLeftOffsetVolt';
bio(173).ndims=2;
bio(173).size=[];
bio(173).isStruct=false;

bio(174).blkName='Trike Application Layer/System_Control/TiltingControl/Offset_Conversion/Discrete Filter';
bio(174).sigName='';
bio(174).portIdx=0;
bio(174).dim=[1,1];
bio(174).sigWidth=1;
bio(174).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DiscreteFilter';
bio(174).ndims=2;
bio(174).size=[];
bio(174).isStruct=false;

bio(175).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Discrete-Time Integrator';
bio(175).sigName='Integral';
bio(175).portIdx=0;
bio(175).dim=[1,1];
bio(175).sigWidth=1;
bio(175).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Integral';
bio(175).ndims=2;
bio(175).size=[];
bio(175).isStruct=false;

bio(176).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Discrete-Time Integrator1';
bio(176).sigName='';
bio(176).portIdx=0;
bio(176).dim=[1,1];
bio(176).sigWidth=1;
bio(176).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DiscreteTimeIntegrator1';
bio(176).ndims=2;
bio(176).size=[];
bio(176).isStruct=false;

bio(177).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/AntiWindup';
bio(177).sigName='';
bio(177).portIdx=0;
bio(177).dim=[1,1];
bio(177).sigWidth=1;
bio(177).sigAddress='&SpeedgoatCANOpen2Buses100us_B.AntiWindup';
bio(177).ndims=2;
bio(177).size=[];
bio(177).isStruct=false;

bio(178).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Derivative Gain';
bio(178).sigName='';
bio(178).portIdx=0;
bio(178).dim=[1,1];
bio(178).sigWidth=1;
bio(178).sigAddress='&SpeedgoatCANOpen2Buses100us_B.DerivativeGain';
bio(178).ndims=2;
bio(178).size=[];
bio(178).isStruct=false;

bio(179).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/FilterOrder';
bio(179).sigName='Derivative';
bio(179).portIdx=0;
bio(179).dim=[1,1];
bio(179).sigWidth=1;
bio(179).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Derivative';
bio(179).ndims=2;
bio(179).size=[];
bio(179).isStruct=false;

bio(180).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Integral Gain';
bio(180).sigName='';
bio(180).portIdx=0;
bio(180).dim=[1,1];
bio(180).sigWidth=1;
bio(180).sigAddress='&SpeedgoatCANOpen2Buses100us_B.IntegralGain';
bio(180).ndims=2;
bio(180).size=[];
bio(180).isStruct=false;

bio(181).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Proportional  Gain';
bio(181).sigName='Proportional';
bio(181).portIdx=0;
bio(181).dim=[1,1];
bio(181).sigWidth=1;
bio(181).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Proportional';
bio(181).ndims=2;
bio(181).size=[];
bio(181).isStruct=false;

bio(182).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/c1';
bio(182).sigName='';
bio(182).portIdx=0;
bio(182).dim=[1,1];
bio(182).sigWidth=1;
bio(182).sigAddress='&SpeedgoatCANOpen2Buses100us_B.c1';
bio(182).ndims=2;
bio(182).size=[];
bio(182).isStruct=false;

bio(183).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Product';
bio(183).sigName='';
bio(183).portIdx=0;
bio(183).dim=[1,1];
bio(183).sigWidth=1;
bio(183).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Product';
bio(183).ndims=2;
bio(183).size=[];
bio(183).isStruct=false;

bio(184).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Product1';
bio(184).sigName='';
bio(184).portIdx=0;
bio(184).dim=[1,1];
bio(184).sigWidth=1;
bio(184).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Product1';
bio(184).ndims=2;
bio(184).size=[];
bio(184).isStruct=false;

bio(185).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Product2';
bio(185).sigName='';
bio(185).portIdx=0;
bio(185).dim=[1,1];
bio(185).sigWidth=1;
bio(185).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Product2';
bio(185).ndims=2;
bio(185).size=[];
bio(185).isStruct=false;

bio(186).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Saturation';
bio(186).sigName='';
bio(186).portIdx=0;
bio(186).dim=[1,1];
bio(186).sigWidth=1;
bio(186).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Saturation';
bio(186).ndims=2;
bio(186).size=[];
bio(186).isStruct=false;

bio(187).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Sum';
bio(187).sigName='';
bio(187).portIdx=0;
bio(187).dim=[1,1];
bio(187).sigWidth=1;
bio(187).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Sum';
bio(187).ndims=2;
bio(187).size=[];
bio(187).isStruct=false;

bio(188).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Sum1';
bio(188).sigName='e';
bio(188).portIdx=0;
bio(188).dim=[1,1];
bio(188).sigWidth=1;
bio(188).sigAddress='&SpeedgoatCANOpen2Buses100us_B.e';
bio(188).ndims=2;
bio(188).size=[];
bio(188).isStruct=false;

bio(189).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Sum2';
bio(189).sigName='';
bio(189).portIdx=0;
bio(189).dim=[1,1];
bio(189).sigWidth=1;
bio(189).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Sum2';
bio(189).ndims=2;
bio(189).size=[];
bio(189).isStruct=false;

bio(190).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Sum3';
bio(190).sigName='';
bio(190).portIdx=0;
bio(190).dim=[1,1];
bio(190).sigWidth=1;
bio(190).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Sum3';
bio(190).ndims=2;
bio(190).size=[];
bio(190).isStruct=false;

bio(191).blkName='Trike Application Layer/System_Control/TiltingControl/PID_ctrl/Sum4';
bio(191).sigName='';
bio(191).portIdx=0;
bio(191).dim=[1,1];
bio(191).sigWidth=1;
bio(191).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Sum4';
bio(191).ndims=2;
bio(191).size=[];
bio(191).isStruct=false;

bio(192).blkName='Trike Application Layer/System_Init/Subsystem/Compare To Constant/Compare';
bio(192).sigName='';
bio(192).portIdx=0;
bio(192).dim=[1,1];
bio(192).sigWidth=1;
bio(192).sigAddress='&SpeedgoatCANOpen2Buses100us_B.Compare';
bio(192).ndims=2;
bio(192).size=[];
