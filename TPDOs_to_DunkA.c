 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Jul 03 12:00:30 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TPDOs_to_DunkA
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            5
/* Input Port  0 */
#define IN_PORT_0_NAME        ClearError
...
/* Input Port  1 */
#define IN_PORT_1_NAME        DeviceMode
...
/* Input Port  2 */
#define IN_PORT_2_NAME        PowerEnable
...
/* Input Port  3 */
#define IN_PORT_3_NAME        BrakeCtrl
...
/* Input Port  4 */
#define IN_PORT_4_NAME        DesiredCurrent
...
{
    const uint8_T *ClearError = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    const uint8_T *DeviceMode = (uint8_T *) ssGetInputPortRealSignal(S, 1);
    const uint8_T *PowerEnable = (uint8_T *) ssGetInputPortRealSignal(S, 2);
    const uint8_T *BrakeCtrl = (uint8_T *) ssGetInputPortRealSignal(S, 3);
    const int32_T *DesiredCurrent = (int32_T *) ssGetInputPortRealSignal(S, 4);

    TPDOs_to_DunkA_Outputs_wrapper(ClearError, DeviceMode, PowerEnable, BrakeCtrl, DesiredCurrent);
