 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 02 19:54:21 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME RPDOs_DunkB
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       OperationMode
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       CurrentActualValue
...
/* Output Port  3 */
#define OUT_PORT_3_NAME       ActualTorque
...
/* Output Port  4 */
#define OUT_PORT_4_NAME       ActualPosition
#define OUTPUT_4_WIDTH        1
#define OUTPUT_DIMS_4_COL     1
#define OUTPUT_4_DTYPE        int32_T
...
/* Output Port  5 */
#define OUT_PORT_5_NAME       ActualVelocity
...
extern void RPDOs_DunkB_Outputs_wrapper(uint16_T *StatusWord,
...
{
    uint16_T *StatusWord = (uint16_T *) ssGetOutputPortRealSignal(S, 0);
    int8_T *OperationMode = (int8_T *) ssGetOutputPortRealSignal(S, 1);
    int16_T *CurrentActualValue = (int16_T *) ssGetOutputPortRealSignal(S, 2);
    int16_T *ActualTorque = (int16_T *) ssGetOutputPortRealSignal(S, 3);
    int32_T *ActualPosition = (int32_T *) ssGetOutputPortRealSignal(S, 4);
    int32_T *ActualVelocity = (int32_T *) ssGetOutputPortRealSignal(S, 5);

    RPDOs_DunkB_Outputs_wrapper(StatusWord, OperationMode, CurrentActualValue, ActualTorque, ActualPosition, ActualVelocity);
