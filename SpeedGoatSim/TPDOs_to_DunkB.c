 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Jul 03 12:01:53 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TPDOs_to_DunkB
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    TPDOs_to_DunkB_Outputs_wrapper(ClearError, DeviceMode, PowerEnable, BrakeCtrl, DesiredCurrent);
