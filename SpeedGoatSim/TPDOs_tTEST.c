 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Jul 02 19:30:20 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TPDOs_tTEST
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void TPDOs_tTEST_Outputs_wrapper(const uint16_T *AN1,
			const uint16_T *AN2,
			const uint16_T *AN3,
			const uint16_T *AN4);
/*====================*
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    TPDOs_tTEST_Outputs_wrapper(AN1, AN2, AN3, AN4);
