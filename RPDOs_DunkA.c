 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 16 19:04:44 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME RPDOs_DunkA
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    RPDOs_DunkA_Outputs_wrapper(StatusWord, OperationMode, CurrentActualValue, ActualTorque, ActualPosition, ActualVelocity);
