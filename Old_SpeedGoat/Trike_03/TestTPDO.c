 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Dec 30 22:23:28 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TestTPDO
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            7
/* Input Port  0 */
#define IN_PORT_0_NAME        S1
...
extern void TestTPDO_Outputs_wrapper(const uint8_T *S1,
			const uint8_T *S2,
			const uint8_T *S3,
			const uint8_T *S4,
			const uint8_T *S5,
...
{
    const uint8_T *S1 = (uint8_T *) ssGetInputPortRealSignal(S, 0);
    const uint8_T *S2 = (uint8_T *) ssGetInputPortRealSignal(S, 1);
    const uint8_T *S3 = (uint8_T *) ssGetInputPortRealSignal(S, 2);
    const uint8_T *S4 = (uint8_T *) ssGetInputPortRealSignal(S, 3);
    const uint8_T *S5 = (uint8_T *) ssGetInputPortRealSignal(S, 4);
    const int16_T *S6 = (int16_T *) ssGetInputPortRealSignal(S, 5);
    const uint8_T *S8 = (uint8_T *) ssGetInputPortRealSignal(S, 6);

    TestTPDO_Outputs_wrapper(S1, S2, S3, S4, S5, S6, S8);
