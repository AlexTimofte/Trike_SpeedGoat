 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Dec 31 11:59:21 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME RPDOs_APT
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       StatusWord
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       PhaseCurrent
...
/* Output Port  3 */
#define OUT_PORT_3_NAME       BusVoltage
...
/* Output Port  4 */
#define OUT_PORT_4_NAME       MotorTemp
...
/* Output Port  5 */
#define OUT_PORT_5_NAME       APTTemp
#define OUTPUT_5_WIDTH        1
#define OUTPUT_DIMS_5_COL     1
#define OUTPUT_5_DTYPE        int8_T
...
/* Output Port  6 */
#define OUT_PORT_6_NAME       ErrStatus
...
/* Output Port  7 */
#define OUT_PORT_7_NAME       PedalPos
...
/* Output Port  8 */
#define OUT_PORT_8_NAME       Direction
...
{
    uint8_T *StatusWord = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
    int16_T *PhaseCurrent = (int16_T *) ssGetOutputPortRealSignal(S, 1);
    int16_T *Speed = (int16_T *) ssGetOutputPortRealSignal(S, 2);
    uint16_T *BusVoltage = (uint16_T *) ssGetOutputPortRealSignal(S, 3);
    int8_T *MotorTemp = (int8_T *) ssGetOutputPortRealSignal(S, 4);
    int8_T *APTTemp = (int8_T *) ssGetOutputPortRealSignal(S, 5);
    uint8_T *ErrStatus = (uint8_T *) ssGetOutputPortRealSignal(S, 6);
    uint8_T *PedalPos = (uint8_T *) ssGetOutputPortRealSignal(S, 7);
    uint8_T *Direction = (uint8_T *) ssGetOutputPortRealSignal(S, 8);

    RPDOs_APT_Outputs_wrapper(StatusWord, PhaseCurrent, Speed, BusVoltage, MotorTemp, APTTemp, ErrStatus, PedalPos, Direction);
