...
MODEL           = SpeedgoatCANOpen03
MODULES         = rt_matrx.c rt_printf.c rt_logging.c SpeedgoatCANOpen03.c SpeedgoatCANOpen03_capi.c SpeedgoatCANOpen03_data.c SpeedgoatCANOpen03_xcp.c SpeedgoatCANOpen03_xcp_TET.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xpc_datatype_ground.c rt_logging_mmi.c rtw_modelmap_utils.c CANOpenSlave.c host_timer_x86.c xpc_code_profiling_utility_functions.c
MAKEFILE        = SpeedgoatCANOpen03.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Venqo\Desktop\SpeedGoat\Applications\Trike_03
S_FUNCTIONS     = RPDOs_APT_wrapper.c RPDOs_Joystick_wrapper.c TPDOs_Speedgoat_wrapper.c sg_IO602_IO691_read_s.cpp sg_IO602_IO691_setup_s.cpp sg_IO602_IO691_write_s.cpp
...
MODELLIB                  = SpeedgoatCANOpen03lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SpeedgoatCANOpen03_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\SpeedgoatCANOpen03_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\extern\include
