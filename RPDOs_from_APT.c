 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Jul 03 12:00:58 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME RPDOs_from_APT
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  7 */
#define OUT_PORT_7_NAME       Direction
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint8_T *Direction = (uint8_T *) ssGetOutputPortRealSignal(S, 7);

    RPDOs_from_APT_Outputs_wrapper(StatusWord, PhaseCurrent, Speed, BusVoltage, MotorTemp, APTTemp, ErrStatus, Direction);
