 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sun May 22 19:24:13 2022
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TPDOs_to_DunkD
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    TPDOs_to_DunkD_Outputs_wrapper(ClearError, DeviceMode, PowerEnable, BrakeCtrl, DesiredCurrent);
