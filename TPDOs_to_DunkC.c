 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sat Jul 03 12:02:15 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME TPDOs_to_DunkC
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    TPDOs_to_DunkC_Outputs_wrapper(ClearError, DeviceMode, PowerEnable, BrakeCtrl, DesiredCurrent);
