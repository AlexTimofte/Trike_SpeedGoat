 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 02 19:58:12 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME RPDOs_DunkD
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void RPDOs_DunkD_Outputs_wrapper(uint16_T *StatusWord,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    RPDOs_DunkD_Outputs_wrapper(StatusWord, OperationMode, CurrentActualValue, ActualTorque, ActualPosition, ActualVelocity);
