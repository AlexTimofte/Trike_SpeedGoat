 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 16 19:12:29 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME AN2CAN_converter
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    AN2CAN_converter_Outputs_wrapper(Channel_AN1, Channel_AN2, Channel_AN3, Channel_AN4);
